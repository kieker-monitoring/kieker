...
public class TestThreadsStatusRecordPropertyOrder extends AbstractKiekerTest {
	...
	/** Constant value parameter for threadCount. */
	private static final long PROPERTY_THREAD_COUNT = 3L;
	/** Constant value parameter for daemonThreadCount. */
	private static final long PROPERTY_DAEMON_THREAD_COUNT = 4L;
	/** Constant value parameter for peakThreadCount. */
	 ...
	 * Empty constructor.
	 */
	public TestThreadsStatusRecordPropertyOrder() {
		// Empty constructor for test class.
	}

	/**
	 * Test property order processing of {@link kieker.common.record.jvm.ThreadsStatusRecord} constructors and
	 * different serialization routines.
	 */
	@Test
	public void testThreadsStatusRecordPropertyOrder() { // NOPMD
	...
	/**
	 * Assertions for ThreadsStatusRecord.
	 */
	private void assertThreadsStatusRecord(final ThreadsStatusRecord record) {
		...
		Assert.assertEquals("'threadCount' value assertion failed.", record.getThreadCount(), PROPERTY_THREAD_COUNT);
		Assert.assertEquals("'daemonThreadCount' value assertion failed.", record.getDaemonThreadCount(), PROPERTY_DAEMON_THREAD_COUNT);
