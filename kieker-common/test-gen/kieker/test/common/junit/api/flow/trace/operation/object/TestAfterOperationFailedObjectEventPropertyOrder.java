...
/**
 * Tests for kieker.common.record.flow.trace.operation.object.AfterOperationFailedObjectEvent records.
 * 
 * @author Reiner Jung
 * 
 * @since 1.10
...
public class TestAfterOperationFailedObjectEventPropertyOrder extends AbstractKiekerTest {
	...
	public void testAfterOperationFailedObjectEventPropertyOrder() { // NOPMD
		...
		final ByteBuffer inputBuffer = this.createByteBuffer(AfterOperationFailedObjectEvent.SIZE, 
			this.makeStringRegistry(),
			PROPERTY_TIMESTAMP, PROPERTY_TRACE_ID, PROPERTY_ORDER_INDEX, PROPERTY_OPERATION_SIGNATURE, PROPERTY_CLASS_SIGNATURE, PROPERTY_CAUSE, PROPERTY_OBJECT_ID);
		final Object[] values = { PROPERTY_TIMESTAMP, PROPERTY_TRACE_ID, PROPERTY_ORDER_INDEX, PROPERTY_OPERATION_SIGNATURE, PROPERTY_CLASS_SIGNATURE, PROPERTY_CAUSE, PROPERTY_OBJECT_ID };
					
		final AfterOperationFailedObjectEvent recordInitParameter = new AfterOperationFailedObjectEvent(PROPERTY_TIMESTAMP, PROPERTY_TRACE_ID, PROPERTY_ORDER_INDEX, PROPERTY_OPERATION_SIGNATURE, PROPERTY_CLASS_SIGNATURE, PROPERTY_CAUSE, PROPERTY_OBJECT_ID);
