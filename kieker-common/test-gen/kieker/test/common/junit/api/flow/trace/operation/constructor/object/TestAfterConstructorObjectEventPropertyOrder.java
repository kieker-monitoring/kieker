...
public class TestAfterConstructorObjectEventPropertyOrder extends AbstractKiekerTest {
	 ...
	 * Empty constructor.
	 */
	public TestAfterConstructorObjectEventPropertyOrder() {
		// Empty constructor for test class.
	}

	/**
	 * Test property order processing of {@link kieker.common.record.flow.trace.operation.constructor.object.AfterConstructorObjectEvent} constructors and
	 * different serialization routines.
	 */
	@Test
	public void testAfterConstructorObjectEventPropertyOrder() { // NOPMD
		...
		final AfterConstructorObjectEvent recordInitBuffer = new AfterConstructorObjectEvent(inputBuffer, this.makeStringRegistry());
	...
	/**
	 * Assertions for AfterConstructorObjectEvent.
	 */
	private void assertAfterConstructorObjectEvent(final AfterConstructorObjectEvent record) {
