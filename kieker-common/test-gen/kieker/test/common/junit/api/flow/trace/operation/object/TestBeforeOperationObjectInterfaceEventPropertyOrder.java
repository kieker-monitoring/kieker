...
public class TestBeforeOperationObjectInterfaceEventPropertyOrder extends AbstractKiekerTest {
	 ...
	 * Empty constructor.
	 */
	public TestBeforeOperationObjectInterfaceEventPropertyOrder() {
		// Empty constructor for test class.
	}

	/**
	 * Test property order processing of {@link kieker.common.record.flow.trace.operation.object.BeforeOperationObjectInterfaceEvent} constructors and
	 * different serialization routines.
	 */
	@Test
	public void testBeforeOperationObjectInterfaceEventPropertyOrder() { // NOPMD
		...
		final BeforeOperationObjectInterfaceEvent recordInitBuffer = new BeforeOperationObjectInterfaceEvent(inputBuffer, this.makeStringRegistry());
	...
	/**
	 * Assertions for BeforeOperationObjectInterfaceEvent.
	 */
	private void assertBeforeOperationObjectInterfaceEvent(final BeforeOperationObjectInterfaceEvent record) {
