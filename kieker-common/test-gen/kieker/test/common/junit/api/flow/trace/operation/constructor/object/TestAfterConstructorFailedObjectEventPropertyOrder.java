...
public class TestAfterConstructorFailedObjectEventPropertyOrder extends AbstractKiekerTest {
	 ...
	 * Empty constructor.
	 */
	public TestAfterConstructorFailedObjectEventPropertyOrder() {
		// Empty constructor for test class.
	}

	/**
	 * Test property order processing of {@link kieker.common.record.flow.trace.operation.constructor.object.AfterConstructorFailedObjectEvent} constructors and
	...
	public void testAfterConstructorFailedObjectEventPropertyOrder() { // NOPMD
		...
		final AfterConstructorFailedObjectEvent recordInitBuffer = new AfterConstructorFailedObjectEvent(inputBuffer, this.makeStringRegistry());
	 ...
	 */
	private void assertAfterConstructorFailedObjectEvent(final AfterConstructorFailedObjectEvent record) {
