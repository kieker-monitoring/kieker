...
/**
 * Tests for kieker.common.record.flow.trace.operation.constructor.AfterConstructorFailedEvent records.
 * 
 * @author Reiner Jung
 * 
 * @since 1.10
...
public class TestAfterConstructorFailedEventPropertyOrder extends AbstractKiekerTest {
	...
	public void testAfterConstructorFailedEventPropertyOrder() { // NOPMD
		...
		final ByteBuffer inputBuffer = this.createByteBuffer(AfterConstructorFailedEvent.SIZE, 
		...
		final AfterConstructorFailedEvent recordInitParameter = new AfterConstructorFailedEvent(PROPERTY_TIMESTAMP, PROPERTY_TRACE_ID, PROPERTY_ORDER_INDEX, PROPERTY_OPERATION_SIGNATURE, PROPERTY_CLASS_SIGNATURE, PROPERTY_CAUSE);
