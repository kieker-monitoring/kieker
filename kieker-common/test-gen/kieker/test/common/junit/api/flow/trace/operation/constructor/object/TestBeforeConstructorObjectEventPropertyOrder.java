...
public class TestBeforeConstructorObjectEventPropertyOrder extends AbstractKiekerTest {
	...
	public void testBeforeConstructorObjectEventPropertyOrder() { // NOPMD
		...
		final BeforeConstructorObjectEvent recordInitBuffer = new BeforeConstructorObjectEvent(DefaultValueDeserializer.instance(), inputBuffer, this.makeStringRegistry());
