...
/**
 * Test API of {@link kieker.common.record.flow.trace.concurrency.monitor.MonitorExitEvent}.
 * 
 * @author API Checker
 * 
 * @since 1.12
...
public class TestMonitorExitEventPropertyOrder extends AbstractKiekerTest {
	...
	/**
	 * Test property order processing of {@link kieker.common.record.flow.trace.concurrency.monitor.MonitorExitEvent} constructors and
	...
	public void testMonitorExitEventPropertyOrder() { // NOPMD
		...
		final ByteBuffer inputBuffer = APIEvaluationFunctions.createByteBuffer(MonitorExitEvent.SIZE, 
			this.makeStringRegistry(), values);
					
		final MonitorExitEvent recordInitParameter = new MonitorExitEvent(
			PROPERTY_TIMESTAMP,
			PROPERTY_TRACE_ID,
			PROPERTY_ORDER_INDEX,
			PROPERTY_LOCK_ID
		);
		final MonitorExitEvent recordInitBuffer = new MonitorExitEvent(DefaultValueDeserializer.instance(), inputBuffer, this.makeStringRegistry());
