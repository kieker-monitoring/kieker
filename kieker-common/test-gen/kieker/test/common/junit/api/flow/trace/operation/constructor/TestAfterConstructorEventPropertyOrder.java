...
/**
 * Tests for kieker.common.record.flow.trace.operation.constructor.AfterConstructorEvent records.
 * 
 * @author Reiner Jung
 * 
 * @since 1.10
...
public class TestAfterConstructorEventPropertyOrder extends AbstractKiekerTest {
	...
	public void testAfterConstructorEventPropertyOrder() { // NOPMD
		...
		final ByteBuffer inputBuffer = this.createByteBuffer(AfterConstructorEvent.SIZE, 
		...
		final AfterConstructorEvent recordInitParameter = new AfterConstructorEvent(PROPERTY_TIMESTAMP, PROPERTY_TRACE_ID, PROPERTY_ORDER_INDEX, PROPERTY_OPERATION_SIGNATURE, PROPERTY_CLASS_SIGNATURE);
