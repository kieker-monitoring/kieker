...
public class MonitorWaitEvent extends AbstractMonitorEvent  {
	 ...
	 */
	public MonitorWaitEvent(final IValueDeserializer deserializer, final ByteBuffer buffer, final IRegistry<String> stringRegistry) throws BufferUnderflowException {
