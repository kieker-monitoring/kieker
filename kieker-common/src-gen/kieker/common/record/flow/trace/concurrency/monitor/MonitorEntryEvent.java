...
public class MonitorEntryEvent extends AbstractMonitorEvent  {
	 ...
	 */
	public MonitorEntryEvent(final IValueDeserializer deserializer, final ByteBuffer buffer, final IRegistry<String> stringRegistry) throws BufferUnderflowException {
