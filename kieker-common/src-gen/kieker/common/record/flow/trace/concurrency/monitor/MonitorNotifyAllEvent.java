...
public class MonitorNotifyAllEvent extends AbstractMonitorEvent  {
	 ...
	 */
	public MonitorNotifyAllEvent(final IValueDeserializer deserializer, final ByteBuffer buffer, final IRegistry<String> stringRegistry) throws BufferUnderflowException {
