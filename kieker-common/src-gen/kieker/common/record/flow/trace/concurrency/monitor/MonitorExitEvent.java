...
public class MonitorExitEvent extends AbstractMonitorEvent  {
	 ...
	 */
	public MonitorExitEvent(final IValueDeserializer deserializer, final ByteBuffer buffer, final IRegistry<String> stringRegistry) throws BufferUnderflowException {
