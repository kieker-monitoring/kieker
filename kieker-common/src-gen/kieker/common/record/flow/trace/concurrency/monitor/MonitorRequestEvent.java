...
public class MonitorRequestEvent extends AbstractMonitorEvent  {
	 ...
	 */
	public MonitorRequestEvent(final IValueDeserializer deserializer, final ByteBuffer buffer, final IRegistry<String> stringRegistry) throws BufferUnderflowException {
