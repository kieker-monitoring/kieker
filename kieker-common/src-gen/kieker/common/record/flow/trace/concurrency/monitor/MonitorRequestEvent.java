...
public class MonitorRequestEvent extends AbstractMonitorEvent  {
	 ...
	 *
	 * @deprecated since 1.13. Use {@link #MonitorRequestEvent(IValueDeserializer)} instead.
	 */
	@Deprecated
	 ...
	 */
	public MonitorRequestEvent(final IValueDeserializer deserializer) throws RecordInstantiationException {
		super(deserializer);
	}
