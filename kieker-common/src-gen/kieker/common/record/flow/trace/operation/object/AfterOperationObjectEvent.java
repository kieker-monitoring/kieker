...
public class AfterOperationObjectEvent extends AfterOperationEvent implements IObjectRecord {
	 ...
	 */
	public AfterOperationObjectEvent(final IValueDeserializer deserializer, final ByteBuffer buffer, final IRegistry<String> stringRegistry) throws BufferUnderflowException {
