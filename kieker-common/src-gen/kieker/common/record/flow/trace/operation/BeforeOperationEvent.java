...
public class BeforeOperationEvent extends AbstractOperationEvent  {
	 ...
	 */
	public BeforeOperationEvent(final IValueDeserializer deserializer, final ByteBuffer buffer, final IRegistry<String> stringRegistry) throws BufferUnderflowException {
