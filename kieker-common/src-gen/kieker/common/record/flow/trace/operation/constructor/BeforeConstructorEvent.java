...
public class BeforeConstructorEvent extends BeforeOperationEvent implements IConstructorRecord {
	 ...
	 */
	public BeforeConstructorEvent(final IValueDeserializer deserializer, final ByteBuffer buffer, final IRegistry<String> stringRegistry) throws BufferUnderflowException {
