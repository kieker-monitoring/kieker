...
public class AfterConstructorObjectEvent extends AfterConstructorEvent implements IObjectRecord {
	 ...
	 */
	public AfterConstructorObjectEvent(final IValueDeserializer deserializer, final ByteBuffer buffer, final IRegistry<String> stringRegistry) throws BufferUnderflowException {
