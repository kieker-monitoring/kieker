...
public class CallConstructorEvent extends CallOperationEvent implements IConstructorRecord {
	 ...
	 */
	public CallConstructorEvent(final IValueDeserializer deserializer, final ByteBuffer buffer, final IRegistry<String> stringRegistry) throws BufferUnderflowException {
