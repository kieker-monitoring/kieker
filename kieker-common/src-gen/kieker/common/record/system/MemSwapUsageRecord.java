...
public class MemSwapUsageRecord extends AbstractMonitoringRecord {
	...
	public boolean equals(final Object obj) {
		...
		if ((this.getLoggingTimestamp() != castedRecord.getLoggingTimestamp()) || (this.getTimestamp() != castedRecord.getTimestamp()) || !this.getHostname().equals(castedRecord.getHostname()) || (this.getMemTotal() != castedRecord.getMemTotal())) {
			return false;
		}
