...
public class TestBeforeOperationObjectEvent extends AbstractKiekerTest {
	...
	public void testSerializeDeserializeEquals() {
		final BeforeOperationObjectEvent event1 = new BeforeOperationObjectEvent(TSTAMP, TRACE_ID,
				ORDER_INDEX, FQ_OPERATION_SIGNATURE, FQ_CLASSNAME, OBJECT_ID);
	...
	public void testSerializeDeserializeBinaryEquals() {
		...
		final BeforeOperationObjectEvent event2 = new BeforeOperationObjectEvent(BinaryValueDeserializer.create(buffer, receiver.getReaderRegistry()));
