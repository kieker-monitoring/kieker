...
public class TestAfterOperationObjectEvent extends AbstractKiekerTest {
	...
	public void testSerializeDeserializeEquals() {
		final AfterOperationObjectEvent event1 = new AfterOperationObjectEvent(TSTAMP, TRACE_ID,
	...
	public void testSerializeDeserializeBinaryEquals() {
		...
		final AfterOperationObjectEvent event2 = new AfterOperationObjectEvent(BinaryValueDeserializer.create(buffer, receiver.getReaderRegistry()));
