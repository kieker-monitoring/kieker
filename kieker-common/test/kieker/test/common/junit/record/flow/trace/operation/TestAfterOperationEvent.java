...
public class TestAfterOperationEvent extends AbstractKiekerTest {
	...
	public void testSerializeDeserializeEquals() {
		...
		final AfterOperationEvent event1 =
				new AfterOperationEvent(TSTAMP, TRACE_ID, ORDER_INDEX, FQ_OPERATION_SIGNATURE, FQ_CLASSNAME);
	...
	public void testSerializeDeserializeBinaryEquals() {
		...
		final AfterOperationEvent event2 = new AfterOperationEvent(DefaultValueDeserializer.instance(), buffer, stringRegistry);
