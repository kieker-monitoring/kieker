...
%% einstellung für mehrere grafiken auf einer seite
%
%
%
...
%% \includepicture
% Erlaubt es ein Bild in ein Dokument einzufügen
%
% Parameter:
%   1. Werte für \includegraphics z.B. die Breite width=11.7cm
...
%% \includepicture
% Erlaubt es ein Bildschirmabbild in ein Dokument einzufügen
...
%% \note
% Erzeugt eine Notiz im Text, welche später noch entfernt werden muss.
% (von Michael um Autor erweitert, da das auch ganz interessant sein könnte...) 
%
% Parameter:
%   1. Autor der Notiz
%   2. Die Notiz
