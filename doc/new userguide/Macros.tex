...
\newcommand{\KiekerWebGUI}{\textsf{Kieker.WebGUI}}
...
\newcommand{\mainJar}{kieker-1.10-SNAPSHOT.jar} % will be set automatically by ant 'release' target
\newcommand{\mainJarEMF}{kieker-1.10-SNAPSHOT\_emf.jar} % will be set automatically by ant 'release' target
\newcommand{\mainJarWeaver}{kieker-1.10-SNAPSHOT\_aspectj.jar} % will be set automatically by ant 'release' target
...
\newcommand{\aspectJWeaverJar}{aspectjweaver-1.7.2.jar}
...
\newcommand{\quickstartBookstoreApplicationDirDistro}{\exampleDir/ch2--quickstart}
...
\newcommand{\KiekerWebGUIDir}{kieker-webgui-\version{}\_binaries}
