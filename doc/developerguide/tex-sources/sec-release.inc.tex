...
\end{lstlisting}
\item Set the final release version number in the \file{build.xml} and the user guide
...
\end{lstlisting}
\item \file{bin/trace-analysis.sh} \textit{--- inspect generated \file{.html}/\file{.txt} files}
\setBashListing
\begin{lstlisting}
...
diff -r examples/userguide/ch5--trace-monitoring-aspectj/testdata/kieker-20100830-082225522-UTC/kieker-20100830-082225582-UTC-Thread-2.dat \
 <replayed dat file>
\end{lstlisting}
