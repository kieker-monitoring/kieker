...
\setJavaCodeListing
\lstinputlisting[firstline=42, lastline=55, firstnumber=42, caption=Excerpt from MonitoringStarter.java, label=listing:sigarSamplerMonitoringStarterExample]{\SigarExampleDir/src/kieker/examples/userguide/appendixSigar/MonitoringStarter.java}
