...
Kicker's \dir{lib/sigar-native-libs/} folder already includes the right libraries for 32 and 64~bit Linux/Windows platforms. %
...
\setJavaCodeListing
\lstinputlisting[firstline=38, lastline=51, firstnumber=38, caption=Excerpt from MonitoringStarter.java, label=listing:sigarSamplerMonitoringStarterExample]{\SigarExampleDir/src/kicker/examples/userguide/appendixSigar/MonitoringStarter.java}
...
As an example, Kicker includes a \class{CPUMemUsageServletContextListener}. %
...
A sample monitoring log can be found in the directory \dir{\SigarExampleDirDistro/testdata/kicker-20110511-10095928-UTC-avanhoorn-thinkpad-KIEKER-SINGLETON/}.
