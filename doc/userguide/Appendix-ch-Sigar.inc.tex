...
(\file{libsigar-x86-linux.so} and \file{sigar-x86-winnt.[dll|lib]}) and for amd64 platforms (\file{libsigar-amd64-linux.so} and \file{sigar-amd64-winnt.dll}). %
...
\setJavaCodeListing
\lstinputlisting[firstline=40, lastline=49, firstnumber=40, caption=Excerpt from MonitoringStarter.java, label=listing:sigarSamplerMonitoringStarterExample]{\SigarExampleDir/src/periodicSigarExample/MonitoringStarter.java}
