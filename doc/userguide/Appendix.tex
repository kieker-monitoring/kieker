...
\chapter{\KickerMonitoringPart{} Default Configuration}\label{sec:appdx:monitoringproperties}
...
%     The following table shows all libraries which are used by \Kicker\ and explains them briefly. %
% These libraries are included in the \dir{lib/} directory of both the \Kicker{} binary and %
