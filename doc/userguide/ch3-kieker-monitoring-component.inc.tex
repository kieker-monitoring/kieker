\chapter{Kieker Monitoring Component}
	...
	\section{Monitoring Records}
		...
		\setJavaCodeListing
		\lstinputlisting[caption=MyRecord.java, label=listing:MyRecord]{\customComponentsBookstoreApplicationDir/src/mySimpleKiekerExample/MyRecord.java}
	...
	\section{Monitoring Log Writers}
		...
		\setJavaCodeListing
		\lstinputlisting[caption=MyWriter.java, label=listing:MyWriter]{\customComponentsBookstoreApplicationDir/src/mySimpleKiekerExample/MyWriter.java}
