...
\setJavaCodeListing
\lstinputlisting[firstline=52, lastline=70, firstnumber=52, caption=Method \method{sample} from MemSwapUsageSampler.java, label=listing:sigarSamplerMethod]{\kiekerSrcDir/monitoring/kieker/monitoring/sampler/sigar/samplers/MemSwapUsageSampler.java}
