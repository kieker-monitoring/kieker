...
(lines~55--56), and passes this monitoring record to the monitoring controller~%
(line~57). %
...
\setJavaCodeListing
\lstinputlisting[firstline=51, lastline=64, firstnumber=51, caption=Method \method{sample} from MemSwapUsageSampler.java, label=listing:sigarSamplerMethod]{\kiekerSrcDir/monitoring/kieker/monitoring/probe/sigar/samplers/MemSwapUsageSampler.java}
...
\item For immutable record types: additionally implement \class{IMonitoringRecord.Fac\-tory}, a constructor %
...
\setJavaCodeListing
\lstinputlisting[caption=MyResponseTimeRecord.java, label=listing:MyRecord,firstline=26,firstnumber=26]{\customComponentsBookstoreApplicationDir/src/kieker/examples/userguide/ch3and4bookstore/MyResponseTimeRecord.java}
...
\lstinputlisting[firstline=35, lastline=42, firstnumber=35, caption=Excerpt from Bookstore.java, label=listing:cuttingBookstore]{\customComponentsBookstoreApplicationDir/src/kieker/examples/userguide/ch3and4bookstore/Bookstore.java}
...
\lstinputlisting[firstline=28, lastline=29, firstnumber=28, caption=Singleton instance of the monitoring controller stored in a final static variable (excerpt from Bookstore.java), label=listing:cuttingBookstore:finalStaticController]{\customComponentsBookstoreApplicationDir/src/kieker/examples/userguide/ch3and4bookstore/Bookstore.java}
...
that they should not be used in production environments. %
The \class{StreamWriter} simply sends the String representation of incoming %
...
\setJavaCodeListing
\lstinputlisting[caption=MyPipeWriter.java, label=listing:MyWriter,float,firstline=27,firstnumber=27]{\customComponentsBookstoreApplicationDir/src/kieker/examples/userguide/ch3and4bookstore/MyPipeWriter.java}
...
\setPropertiesListing  
\lstinputlisting[caption={Configuration of the custom writer \class{MyPipeWriter}},label=lst:monitoringwriter:MyWriter,firstline=70,firstnumber=70,lastline=75]%
