...
(lines~59--62), and passes this monitoring record to the monitoring controller~%
(line~63). %
...
\setPropertiesListing  
\lstinputlisting[caption={Configuration of the custom writer \class{MyPipeWriter}},label=lst:monitoringwriter:MyWriter,firstline=89,firstnumber=89,lastline=97]%
