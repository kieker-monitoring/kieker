...
(\method{newMonitoringRecord}) employing the configured monitoring writer and %
to retrieve the current timestamp (\method{currentTimeNanos}). %
The method \method{currentTimeNanos} returns the number of nanoseconds elapsed %
since 1 Jan 1970 00:00~UTC. %

The class \class{MonitoringController} is implemented employing the singleton pattern. %
