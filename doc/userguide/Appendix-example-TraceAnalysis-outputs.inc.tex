\subsection{Execution Traces, Message Traces, and Trace Equivalence Classes}

\subsubsection{Execution Traces}

\setTextListing
\lstinputlisting[firstline=1,lastline=10,caption=]{images/example-plots/executionTraces.txt}

\subsubsection{Message Traces}

\setTextListing
\lstinputlisting[firstline=1,lastline=9,caption=]{images/example-plots/messageTraces.txt}

\subsubsection{Trace Equivalence Classes}

\setTextListing
\lstinputlisting[caption=]{images/example-plots/traceDeploymentEquivClasses.txt}

\setTextListing
\lstinputlisting[caption=]{images/example-plots/traceAssemblyEquivClasses.txt}
