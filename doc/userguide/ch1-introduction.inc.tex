...
\noindent The \KiekerMonitoringPart{} component is responsible for program instrumentation, data collection and logging. Its core is the class \class{MonitoringController} which receives the monitoring data in so-called monitoring records and writes these monitoring records into the configured monitoring log. 

The component \KiekerAnalysisPart{} is responsible for the analysis and visualization of the monitoring data. Its core is the class \class{AnalysisController} which manages the life-cycle of the monitoring log reader and all analysis plugins.
