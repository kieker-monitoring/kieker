% The name of Kicker, just for the case that the design of this should change.
\newcommand{\Kicker}{\textsf{Kicker}}

% The current version-string.
\newcommand{\version}{1.10-SNAPSHOT} % will be set automatically by ant 'release' target 

% The single parts of Kicker and some files.
\newcommand{\KickerMonitoringPart}{\textsf{Kicker.\-Monitoring}}
\newcommand{\KickerAnalysisPart}{\textsf{Kicker.\-Analysis}}
\newcommand{\KickerTraceAnalysis}{\textsf{Kicker.Trace\-Analysis}}
% \newcommand{\analysisJar}{kicker-analysis-\version.jar}
\newcommand{\mainJar}{kicker-1.10-SNAPSHOT.jar} % will be set automatically by ant 'release' target
\newcommand{\mainJarEMF}{kicker-1.10-SNAPSHOT\_emf.jar} % will be set automatically by ant 'release' target
\newcommand{\mainJarWeaver}{kicker-1.10-SNAPSHOT\_aspectj.jar} % will be set automatically by ant 'release' target
% \newcommand{\monitoringJar}{kicker-monitoring-\version.jar}
% \newcommand{\commonJar}{kicker-common-\version.jar}
% \newcommand{\toolsJar}{kicker-tools-\version.jar}
\newcommand{\commonsLoggingJar}{commons-logging-1.1.2.jar}
\newcommand{\aspectJWeaverJar}{aspectjweaver-1.8.0.jar}
...
\newcommand{\binaryFileForDownload}{kicker-\version{}\_bina\-ries.zip}
\newcommand{\kickerMonitoringProperties}{kicker.monitoring.pro\-perties}
...
\newcommand{\kickerSrcDir}{../../src/}

\newcommand{\distributedTestdataDir}{\aspectJBookstoreApplicationDir/testdata/kicker-20100830-082225522-UTC}
\newcommand{\distributedTestdataDirDistro}{\aspectJBookstoreApplicationDirDistro/testdata/kicker-20100830-082225522-UTC}
\newcommand{\distributedTestdataDirDistroWin}{..\textbackslash{}\aspectJBookstoreApplicationDirDistroWin\textbackslash{}testdata\textbackslash{}kicker-20100830-082225522-UTC}
...
\newcommand{\KickerURL}{\url{http://kicker-monitoring.net}} 
% \newcommand{\KickerDownloadURL}{\url{http://sourceforge.net/projects/kicker/files}}
\newcommand{\KickerDownloadURL}{\url{http://kicker-monitoring.net/download/}}

% This is how we call the kicker directory.
\newcommand{\KickerDir}{kicker-\version{}}%{$<$KIEKER-DIR$>$}
