...
\newcommand{\version}{1.5-SNAPSHOT} % will be set automatically by ant 'release' target 
...
\newcommand{\mainJar}{kieker-1.5-SNAPSHOT.jar} % will be set automatically by ant 'release' target
\newcommand{\mainJarEMF}{kieker-1.5-SNAPSHOT\_emf.jar} % will be set automatically by ant 'release' target
\newcommand{\mainJarWeaver}{kieker-1.5-SNAPSHOT\_aspectj.jar} % will be set automatically by ant 'release' target
