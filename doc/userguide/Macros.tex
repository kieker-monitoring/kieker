...
\newcommand{\KiekerTraceAnalysis}{\textsf{Kieker.Trace\-Analyis}}
...
\newcommand{\exampleDirFull}{\userGuideDir/\exampleDir}
\newcommand{\plainBookstoreApplicationDir}{\exampleDir/ch2--bookstore-application}
\newcommand{\manualInstrumentedBookstoreApplicationDir}{\exampleDir/ch2--manual-instrumentation}
\newcommand{\customComponentsBookstoreApplicationDir}{\exampleDir/ch3-4--custom-components}
\newcommand{\aspectJBookstoreApplicationDir}{\exampleDir/ch5--aspectj-instrumentation}
...
morekeywords={java,javac,-classpath,-d,-jar,-javaagent:,copy,cp},
% showspaces=true
% emphstyle=\bfseries
}
