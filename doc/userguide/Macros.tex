...
\newcommand{\version}{1.6} % will be set automatically by ant 'release' target 
...
\newcommand{\mainJar}{kieker-1.6.jar} % will be set automatically by ant 'release' target
\newcommand{\mainJarEMF}{kieker-1.6\_emf.jar} % will be set automatically by ant 'release' target
\newcommand{\mainJarWeaver}{kieker-1.6\_aspectj.jar} % will be set automatically by ant 'release' target
