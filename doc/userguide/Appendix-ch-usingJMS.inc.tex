...
and decompress it to the root directory of the example. Unter UNIX-like systems, make sure that the executable-bit of all scripts within the \dir{bin/} directory are set.
