...
The file \file{\JMSBookstoreApplicationDirDistro/META-INF/kicker.monitoring.\-pro\-perties-activeMQ} %
...
\lstinputlisting[firstline=12,lastline=12,caption=Excerpt from \file{kicker.monitoring.properties-activemq} configuring the provider URL of the JMS writer via ActiveMQ]{\JMSBookstoreApplicationDir/META-INF/kicker.monitoring.properties-activemq}

\setPropertiesListing
\lstinputlisting[firstline=21,lastline=21,caption=Excerpt from \file{kicker.monitoring.properties-activemq} configuring the context factory of the JMS writer via ActiveMQ]{\JMSBookstoreApplicationDir/META-INF/kicker.monitoring.properties-activemq}
...
\subsection{Kicker Monitoring Configuration for HornetQ}

The file \file{\JMSBookstoreApplicationDirDistro/META-INF/kicker.monitoring.\-pro\-perties-hornetq} %
...
\setPropertiesListing
\lstinputlisting[firstline=12,lastline=12,caption=Excerpt from \file{kicker.monitoring.properties-hornetq} configuring the provider URL of the JMS writer via HornetQ]{\JMSBookstoreApplicationDir/META-INF/kicker.monitoring.properties-hornetq}

\setPropertiesListing
\lstinputlisting[firstline=21,lastline=21,caption=Excerpt from \file{kicker.monitoring.properties-hornetq} configuring the context factory of the JMS writer via HornetQ]{\JMSBookstoreApplicationDir/META-INF/kicker.monitoring.properties-hornetq}
...
\subsection{Kicker Monitoring Configuration for OpenJMS}

The file \file{\JMSBookstoreApplicationDirDistro/META-INF/kicker.monitoring.\-pro\-perties-openjms} %
is already configured to use the \class{AsyncJMSWriter} via OpenJMS. The important properties are %
the definition of the provider URL and the context factory:

\setPropertiesListing
\lstinputlisting[firstline=12,lastline=12,caption=Excerpt from \file{kicker.monitoring.properties-openjms} configuring the provider URL of the JMS writer via OpenJMS]{\JMSBookstoreApplicationDir/META-INF/kicker.monitoring.properties-openjms}

\setPropertiesListing
\lstinputlisting[firstline=21,lastline=21,caption=Excerpt from \file{kicker.monitoring.properties-openjms} configuring the context factory of the JMS writer via OpenJMS]{\JMSBookstoreApplicationDir/META-INF/kicker.monitoring.properties-openjms}
