...
\setPropertiesListing
\lstinputlisting[firstline=152,lastline=152,caption=Excerpt from \file{kieker.monitoring.properties-activemq} configuring the context factory of the JMS writer via ActiveMQ]{\JMSBookstoreApplicationDir/META-INF/kieker.monitoring.properties-activemq}
...
\setPropertiesListing
\lstinputlisting[firstline=152,lastline=152,caption=Excerpt from \file{kieker.monitoring.properties-hornetq} configuring the context factory of the JMS writer via HornetQ]{\JMSBookstoreApplicationDir/META-INF/kieker.monitoring.properties-hornetq}
...
\setPropertiesListing
\lstinputlisting[firstline=152,lastline=152,caption=Excerpt from \file{kieker.monitoring.properties-openjms} configuring the context factory of the JMS writer via OpenJMS]{\JMSBookstoreApplicationDir/META-INF/kieker.monitoring.properties-openjms}
