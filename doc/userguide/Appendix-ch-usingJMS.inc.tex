...
\setXMLListing
\begin{lstlisting}[caption=Queue definition to be added to the the HornetQ configuration file,label=lst:hornetq:config:queue,numbers=none]
...
\setPropertiesListing
\lstinputlisting[firstline=143,lastline=143,caption=Excerpt from \file{kieker.monitoring.properties-hornetq} configuring the provider URL of the JMS writer via HornetQ]{\JMSBookstoreApplicationDir/META-INF/kieker.monitoring.properties-openjms}
