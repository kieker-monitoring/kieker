\chapter{Kieker Analysis Component}
	...
	\section{Monitoring Log Readers}
		...
		\setJavaCodeListing
		\lstinputlisting[caption=MyReader.java, label=listing:MyReader]{\customComponentsBookstoreApplicationDir/src/mySimpleKiekerExample/MyReader.java}
	...
	\section{Record Consumer Plugins}
		...
		\setJavaCodeListing
		\lstinputlisting[caption=MyConsumer.java]{\customComponentsBookstoreApplicationDir/src/mySimpleKiekerExample/MyConsumer.java}
