...
\setJavaCodeListing
\lstinputlisting[firstline=64, firstnumber=64, lastline=83, caption={Example reader's \method{read} method}, label=listing:MyPipeReaderRead]%
{\customComponentsBookstoreApplicationDir/src/kieker/examples/userguide/ch3and4bookstore/MyPipeReader.java}
...
\setJavaCodeListing
\lstinputlisting[firstline=156, firstnumber=156, lastline=157, caption={Accessing a repository within a plugin}, label=listing:RepositoryAccess]%
{../../src/tools/kieker/tools/traceAnalysis/filter/AbstractTraceAnalysisFilter.java}
