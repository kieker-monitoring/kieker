...
\setJavaCodeListing
\lstinputlisting[caption=Initializing and connecting the example reader and filter (Starter.java),label=listing:StarterInitConnect,firstline=48, lastline=66, firstnumber=48]%
...
\setJavaCodeListing
\lstinputlisting[firstline=43, firstnumber=43, lastline=57, caption={Plugin constructor accepting a \class{Configuration} and an \class{IProjectContext} object}, label=listing:MyResponseTimeFilterConstructor]%
...
\setJavaCodeListing
\lstinputlisting[firstline=78, firstnumber=78, lastline=84, caption={Plugin returning its current configuration}, label=listing:MyResponseTimeFilterEventsToOutput]%
{\customComponentsBookstoreApplicationDir/src/kieker/examples/userguide/ch3and4bookstore/MyResponseTimeFilter.java}
...
\setJavaCodeListing
\lstinputlisting[firstline=32, firstnumber=32, lastline=44, caption={@Plugin annotation for the example plugin \class{MyResponseTimeFilter}}, label=listing:MyResponseTimeFilterPluginAnnotationOutputs]%
{\customComponentsBookstoreApplicationDir/src/kieker/examples/userguide/ch3and4bookstore/MyResponseTimeFilter.java}
...
\setJavaCodeListing
\lstinputlisting[firstline=70, firstnumber=70, lastline=77, caption={Plugin sending events to output ports}, label=listing:MyResponseTimeFilterDelivers]%
{\customComponentsBookstoreApplicationDir/src/kieker/examples/userguide/ch3and4bookstore/MyResponseTimeFilter.java}

Listing~\ref{listing:MyResponseTimeFilterPluginAnnotationOutputs} shows also how %
the properties are declared. Using the @Property annotation, it is possible to declare %
the existing properties. Each property has a default value which should be sufficient %
to initialize the plugin.%

The @Plugin annotation (as well as the later introduced @Repository annotation) contains %
...
\setJavaCodeListing
\lstinputlisting[firstline=35, firstnumber=35, lastline=46, caption={@Plugin annotation for the example reader}, label=listing:MyPipeReaderPluginAnnotation]%
...
\setJavaCodeListing
\lstinputlisting[firstline=57, firstnumber=57, lastline=67, caption={Example reader's initialization in the constructor (excerpt)}, label=listing:MyPipeReaderInit]%
{\customComponentsBookstoreApplicationDir/src/kieker/examples/userguide/ch3and4bookstore/MyPipeReader.java}
...
\setJavaCodeListing
\lstinputlisting[firstline=74, firstnumber=74, lastline=93, caption={Example reader's \method{read} method}, label=listing:MyPipeReaderRead]%
{\customComponentsBookstoreApplicationDir/src/kieker/examples/userguide/ch3and4bookstore/MyPipeReader.java}
...
\setJavaCodeListing
\lstinputlisting[firstline=66, firstnumber=66, lastline=70, caption={@InputPort annotation for the example plugin's input method}, label=listing:MyResponseTimeFilterInputPort]%
{\customComponentsBookstoreApplicationDir/src/kieker/examples/userguide/ch3and4bookstore/MyResponseTimeFilter.java}
...
\setJavaCodeListing
\lstinputlisting[firstline=41, firstnumber=41, lastline=44, caption={\class{@Respository} annotation of Kieker's \class{SystemModelRepository}}, label=listing:RepositoryAnnotation]%
...
\setJavaCodeListing
\lstinputlisting[firstline=166, firstnumber=166, lastline=167, caption={Accessing a repository within a plugin}, label=listing:RepositoryAccess]%
{../../src/tools/kieker/tools/traceAnalysis/filter/AbstractTraceAnalysisFilter.java}
