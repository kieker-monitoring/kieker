...
\setJavaCodeListing
\lstinputlisting[firstline=42, firstnumber=42, lastline=43, caption={Declaration of required repositories in the @Repository annotation}, label=listing:RepositoryRequirementDeclaration]%
