...
\noindent If everything worked correctly, a new directory for the monitoring data with a name similar to \dir{kieker-20110427-142244899-UTC-Kaapstad-KIEKER-SINGLETON/} is created (see Listing \ref{fig:logtree}). %
