...
\lstinputlisting[caption=BookstoreStarter.java,label=lst:class:BookstoreStarter,firstline=21,firstnumber=21]{\plainBookstoreApplicationDir/src/kieker/examples/userguide/ch2bookstore/BookstoreStarter.java}
...
\lstinputlisting[caption=Bookstore.java,label=lst:class:Bookstore,firstline=21,firstnumber=21]{\plainBookstoreApplicationDir/src/kieker/examples/userguide/ch2bookstore/Bookstore.java}
...
\lstinputlisting[caption=CRM.java,label=lst:class:CRM,firstline=21,firstnumber=21]{\plainBookstoreApplicationDir/src/kieker/examples/userguide/ch2bookstore/CRM.java}
...
\lstinputlisting[caption=Catalog.java,label=lst:class:Catalog,firstline=21,firstnumber=21]{\plainBookstoreApplicationDir/src/kieker/examples/userguide/ch2bookstore/Catalog.java}
...
\lstinputlisting[float,caption=Consumer.java, label=lst:Consumer,firstline=21,firstnumber=21]{\manualInstrumentedBookstoreApplicationDir/src/kieker/examples/userguide/ch2bookstore/manual/Consumer.java}
