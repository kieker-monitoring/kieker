...
\lstinputlisting[caption=BookstoreStarter.java,label=lst:class:BookstoreStarter]{source-example/plain-example/src/bookstoreApplication/BookstoreStarter.java}
\TODO{FIX IT}
...
\lstinputlisting[caption=Bookstore.java,label=lst:class:Bookstore]{source-example/plain-example/src/bookstoreApplication/Bookstore.java}
...
\lstinputlisting[caption=CRM.java,label=lst:class:CRM]{source-example/plain-example/src/bookstoreApplication/CRM.java}
...
\lstinputlisting[caption=Catalog.java,label=lst:class:Catalog]{source-example/plain-example/src/bookstoreApplication/Catalog.java}
