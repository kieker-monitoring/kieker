...
% Before any analysis can take place, the \file{\analysisJar} has to be copied from the \dir{\KiekerDir/dist/} directory and placed in the \dir{lib/} directory of the example as shown in Figure~\ref{lst:analysisExampleLayout}. 
...
\noindent The analysis application itself comprises the files \file{Consumer.java} and \file{BookstoreAnalysisStarter.java} (as shown in Figure~\ref{lst:analysisExampleLayout}) %
