...
\noindent \Kieker{} logs monitoring data provided by so-called monitoring records. %
Section~\ref{sec:componentsMonitoring:monitoringRecords} describes how to define and use custom monitoring record types. %
The record type used in this example is an \textit{operation execution record} which %
...
There are different writers available, as detailed in Section~\ref{sec:monitoring-log-writers}.
