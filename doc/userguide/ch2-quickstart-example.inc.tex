...
\noindent If everything worked correctly, a new directory for the monitoring data with a name similar to \dir{tpmon-20100727-181422131-UTC/} is created (see Listing \ref{fig:logtree}). %
...
file named \dir{tpmon.map} which contains information on the types of monitoring records used. 
...
\setBashListing
\lstinputlisting[caption=tpmon-20100727-181422234-UTC-Thread-2.dat (excerpt), firstline=1, lastline=2, label=lst:exampledat]%
