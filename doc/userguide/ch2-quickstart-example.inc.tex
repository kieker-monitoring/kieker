...
The file \file{\commonsLoggingJar} is located in the \dir{\KiekerDir/lib/} directory and has to be copied to the \dir{lib/} directory of the example application. The final layout of the example directory is illustrated in Figure~\ref{fig:KiekerBookstoreExample}.
