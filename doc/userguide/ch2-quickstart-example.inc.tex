...
\setJavaCodeListing       
\lstinputlisting[caption=BookstoreAnalysisStarter.java (excerpt from \method{main} method),label=lst:BookstoreAnalysisStarter,firstline=40,firstnumber=40,lastline=60]%
