\chapter{Trace Analysis and Monitoring via AspectJ}
...
and \ref{chap:components}. Once the methods are marked, the AspectJ-Weaver-Agent
...
\section{Full Monitoring}\label{sec:aspectJ:monitoring}
