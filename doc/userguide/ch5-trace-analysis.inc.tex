...
Figure~\ref{fig:bookstoreAOP:dirStructure} shows the directory used by the %
example of this section. %
The jar-file \file{aspectjweaver-1.6.9.jar} is included in the %
\dir{lib/} directory of the \Kieker{} binary release. Its %
\dir{META-INF/} directory contains an example \file{\aopConfigFile}. %
The library \file{aspectjweaver-1.6.9.jar} contains the \textit{AspectJ weaver} %
...
\class{bookstoreTracing}. AspectJ allows to use for the definition of classes to %
...
classname in the include directives of the \aopConfigFile{}.}
...
The command shown in Listings~\ref{lst:traceAnalysis:sequenceDiagram} and \ref{lst:traceAnalysis:sequenceDiagramWin} generate a sequence diagram as well %
as a call tree to an existing directory named \dir{out/}. The monitoring data %
is assumed to be located in the directory %
\dir{/tmp/tpmon-20100813-121041532-UTC} or \dir{C:$\backslash{}$Temp$\backslash{}$tpmon-20100813-121041532-UTC} under Windows. %
