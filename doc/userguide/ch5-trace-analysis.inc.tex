...
with all attributes. The attributes \method{className}, \method{operationName}, %
...
\end{graybox}
\end{figure}
The \file{.pic} and \file{.dot} files can now be converted into a readable format by using graphviz and the plotutils as seen in Listing~\ref{lst:traceAnalysis:convertDiagrams}.
