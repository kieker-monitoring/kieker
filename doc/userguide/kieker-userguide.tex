...
\ifoot[\hrule\sffamily Kicker \version{} User Guide]{\hrule\sffamily Kicker \version{} User Guide}
\ofoot[\hrule\sffamily\pagemark]{\hrule\sffamily\pagemark}

% Set the title and everything.
\titlehead{
  \begin{center}
    \includegraphics[height=25mm]{./images/20120511-kicker-logo-1-6}\\
\href{http://kicker-monitoring.net}{\sffamily\Large http://kicker-monitoring.net}
  \end{center}
}

\title{%
\Huge\Kicker{} \version{} User Guide%
\footnote{\sffamily \textit{For guide lines on how to cite Kicker and this document, please see~Section~\ref{sec:ch1:citingKicker}.}}
}

\author{\sffamily Kicker Project%
% , and contributors
}
\date{\sffamily\today}
...
\hypersetup
{%
pdftitle = {\Kicker{} \version{} User Guide},
...
\begin{document}
  ...
  \input{ch3-kicker-monitoring-component.inc.tex}
  \input{ch4-kicker-analysis-component.inc.tex}
