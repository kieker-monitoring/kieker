\chapter{Kieker Monitoring Component}
	...
	\section{Monitoring Records}
		...
		\setJavaCodeListing
		\lstinputlisting[caption=MyRecord.java, label=listing:MyRecord]{source-example/monitoring-and-analysis-with-own-components/src/mySimpleKiekerExample/MyRecord.java}
	...
	\section{Monitoring Probes}
		...
		\lstinputlisting[firstline=20, lastline=29, caption=Cutting from Bookstore.java, label=listing:cuttingBookstore]{source-example/manual-monitoring/src/bookstoreApplication/Bookstore.java}
	...
	\section{Monitoring Log Writers}
		...
		\setJavaCodeListing
		\lstinputlisting[caption=MyWriter.java, label=listing:MyWriter]{source-example/monitoring-and-analysis-with-own-components/src/mySimpleKiekerExample/MyWriter.java}
