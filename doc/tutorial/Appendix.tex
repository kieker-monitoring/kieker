...
\chapter{Used classes}
	...
	\lstinputlisting{source-example/monitoring-and-analysis-with-own-components/src/mySimpleKiekerExample/MyNamedPipeManager.java}

	\setJavaCodeListing
	\lstset{caption=MyPipe.java}
	\lstinputlisting{source-example/monitoring-and-analysis-with-own-components/src/mySimpleKiekerExample/MyPipe.java}
