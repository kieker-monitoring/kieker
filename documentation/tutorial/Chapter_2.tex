  \chapter{Example}
    ...
    \section{Monitoring}
      ...
      The build-directory will later contain the compiled class files for Java; the src-directory will contain the sourcecode files and the lib-directory the libraries and needed jar-files.\\
