...
kieker-2.0.4-SNAPSHOT-emf.jar to the lib/ directory of the example directory.
The file is located in the ``kieker-2.0.4-SNAPSHOT/build/libs/`` directory of the
...
.. code:: shell
	...
	javac src/kieker/examples/userguide/ch2bookstore/manual/∗.java \
		-classpath lib/kieker-2.0.4-SNAPSHOT-emf.jar -d build/
	
	java -classpath build/:lib/kieker-2.0.4-SNAPSHOT-emf.jar \
