...
`OperationExecutionRecord <http://api.kieker-monitoring.org/2.0.3/kieker/common/record/controlflow/OperationExecutionRecord.html>`__).
...
`JavaDoc <http://api.kieker-monitoring.org/2.0.3/kieker/common/record/controlflow/OperationExecutionRecord.html>`__.
