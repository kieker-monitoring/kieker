...
\begin{figure}\centering
% \vspace{0.4cm}
\subfigure[Kieker.Tpmon]{\label{fig:kieker:coreFrameworkClassesAndInterfaces:tpmon}%
...
\subfigure[Kieker.Tpan]{\label{fig:kieker:coreFrameworkClassesAndInterfaces:tpan}%
...
\caption{Classes and interfaces of the framework components %{\textcolor{red}{S\"{o}ren: Caption evtl. spezifischer?}}
\subref{fig:kieker:coreFrameworkClassesAndInterfaces:tpmon}~Kieker.Tpmon and %
\subref{fig:kieker:coreFrameworkClassesAndInterfaces:tpan}~Kieker.Tpmon. %
% Customized components can be added to the framework %
% by implementing/extending the interfaces and abstract classes. %
}
...
calling a \MonitoringRecord{}'s \classname{init\+FromStringArray(..)} method), see Figure~\ref{fig:kieker:coreFrameworkClassesAndInterfaces:record}. %%
...
\MonitoringLogReaders{} extend the abstract class \classname{Abstract\+Kieker\+Monitoring\+Log\+Reader},
...
% by implementing the \classname{IKiekerRecordConsumer} interface (see Figure~\ref{fig:kieker:coreFrameworkClassesAndInterfaces}). %
