...
To download the agent, execute `wget https://repo1.maven.org/maven2/net/kieker-monitoring/kieker/2.0.4-SNAPSHOT/kieker-2.0.4-SNAPSHOT-bytebuddy.jar`
...
.. code-block:: bash
    ...
    java -javaagent:benchmark/kieker-2.0.4-SNAPSHOT-bytebuddy.jar \
         -jar sut.jar
...
- `AspectJ probes <http://api.kieker-monitoring.org/2.0.4-SNAPSHOT/>`_
