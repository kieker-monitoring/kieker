 ...
 */
@Aspect
public class SpecProbe extends AbstractOperationExecutionAspect {

	private static final Log log = LogFactory.getLog(SpecProbe.class);

	@Pointcut("!execution(* _persistence*(..)) && execution(* org.spec..*(..))")
