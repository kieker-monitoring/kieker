...
-UNIX-like systems:
 $ java -javaagent:lib/aspectjweaver-1.6.11.jar -cp BookstoreApplication.jar:lib/commons-logging-1.1.1.jar:lib/kieker-1.5-SNAPSHOT.jar bookstoreTracing.BookstoreStarter 5
- Windows:
 $ java -javaagent:lib\aspectjweaver-1.6.11.jar -cp BookstoreApplication.jar;lib\commons-logging-1.1.1.jar;lib/kieker-1.5-SNAPSHOT.jar bookstoreTracing.BookstoreStarter 5
