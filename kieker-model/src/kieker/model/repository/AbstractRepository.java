 ...
 * @since 1.1
 */
public abstract class AbstractRepository { // NOPMD (abstract without abstract)

	/** This constant represents the ID of the root element. */
	public static final int ROOT_ELEMENT_ID = 0;

	private final AtomicInteger nextId = new AtomicInteger(AbstractRepository.ROOT_ELEMENT_ID + 1);
