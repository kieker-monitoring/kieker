...
public class TracePackageImpl extends EPackageImpl implements TracePackage {
	...
	public static TracePackage init() {
		...
		TracePackageImpl theTracePackage = (TracePackageImpl) (EPackage.Registry.INSTANCE.get(eNS_URI) instanceof TracePackageImpl
	...
	public void initializePackageContents() {
		...
		initEAttribute(getTrace_TraceID(), ecorePackage.getELong(), "traceID", null, 0, 1, Trace.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
				!IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTrace_RootOperationCall(), this.getOperationCall(), null, "rootOperationCall", null, 0, 1, Trace.class, !IS_TRANSIENT, !IS_VOLATILE,
		...
		initEReference(getOperationCall_Operation(), theDeploymentPackage.getDeployedOperation(), null, "operation", null, 0, 1, OperationCall.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getOperationCall_Parent(), this.getOperationCall(), this.getOperationCall_Children(), "parent", null, 0, 1, OperationCall.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getOperationCall_Children(), this.getOperationCall(), this.getOperationCall_Parent(), "children", null, 0, -1, OperationCall.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOperationCall_Duration(), theAnalysismodelPackage.getDuration(), "duration", null, 0, 1, OperationCall.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOperationCall_Start(), theAnalysismodelPackage.getInstant(), "start", null, 0, 1, OperationCall.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOperationCall_DurRatioToParent(), ecorePackage.getEFloat(), "durRatioToParent", null, 0, 1, OperationCall.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOperationCall_DurRatioToRootParent(), ecorePackage.getEFloat(), "durRatioToRootParent", null, 0, 1, OperationCall.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOperationCall_StackDepth(), ecorePackage.getEInt(), "stackDepth", null, 0, 1, OperationCall.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOperationCall_OrderIndex(), ecorePackage.getEInt(), "orderIndex", null, 0, 1, OperationCall.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOperationCall_Failed(), ecorePackage.getEBoolean(), "failed", "false", 0, 1, OperationCall.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOperationCall_FailedCause(), ecorePackage.getEString(), "failedCause", null, 0, 1, OperationCall.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	}
