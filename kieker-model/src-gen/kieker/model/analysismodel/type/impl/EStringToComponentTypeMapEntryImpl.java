...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>EString To Component Type Map Entry</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class EStringToComponentTypeMapEntryImpl extends MinimalEObjectImpl.Container implements BasicEMap.Entry<String, ComponentType> {
	...
	protected EClass eStaticClass() {
		return TypePackage.Literals.ESTRING_TO_COMPONENT_TYPE_MAP_ENTRY;
	}
	...
	public void setTypedKey(final String newKey) {
		...
		if (this.eNotificationRequired()) {
			this.eNotify(new ENotificationImpl(this, Notification.SET, TypePackage.ESTRING_TO_COMPONENT_TYPE_MAP_ENTRY__KEY, oldKey, this.key));
		}
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetTypedValue(final ComponentType newValue, NotificationChain msgs) {
		final ComponentType oldValue = this.value;
		this.value = newValue;
		if (this.eNotificationRequired()) {
			final ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TypePackage.ESTRING_TO_COMPONENT_TYPE_MAP_ENTRY__VALUE, oldValue,
					newValue);
			if (msgs == null) {
				msgs = notification;
			} else {
	 ...
	 * @generated
	 */
	public void setTypedValue(final ComponentType newValue) {
		if (newValue != this.value) {
			NotificationChain msgs = null;
			if (this.value != null) {
				msgs = ((InternalEObject) this.value).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TypePackage.ESTRING_TO_COMPONENT_TYPE_MAP_ENTRY__VALUE, null,
						msgs);
			}
			if (newValue != null) {
			...
			this.eNotify(new ENotificationImpl(this, Notification.SET, TypePackage.ESTRING_TO_COMPONENT_TYPE_MAP_ENTRY__VALUE, newValue, newValue));
		}
	}
	...
	public void eSet(final int featureID, final Object newValue) {
		...
		case TypePackage.ESTRING_TO_COMPONENT_TYPE_MAP_ENTRY__KEY:
			...
			return;
		case TypePackage.ESTRING_TO_COMPONENT_TYPE_MAP_ENTRY__VALUE:
			this.setTypedValue((ComponentType) newValue);
			return;
		}
	...
	public void eUnset(final int featureID) {
		...
		case TypePackage.ESTRING_TO_COMPONENT_TYPE_MAP_ENTRY__KEY:
			...
			return;
		case TypePackage.ESTRING_TO_COMPONENT_TYPE_MAP_ENTRY__VALUE:
			this.setTypedValue((ComponentType) null);
			return;
		}
	 ...
	 */
	@Override
	public ComponentType setValue(final ComponentType value) {
		final ComponentType oldValue = this.getValue();
	...
	public EMap<String, ComponentType> getEMap() {
		...
		return container == null ? null : (EMap<String, ComponentType>) container.eGet(this.eContainmentFeature());
	}
