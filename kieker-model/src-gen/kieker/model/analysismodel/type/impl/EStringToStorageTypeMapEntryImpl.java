...
public class EStringToStorageTypeMapEntryImpl extends MinimalEObjectImpl.Container implements BasicEMap.Entry<String,StorageType> {
	...
	public void setTypedKey(String newKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypePackage.ESTRING_TO_STORAGE_TYPE_MAP_ENTRY__KEY, oldKey, key));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetTypedValue(StorageType newValue, NotificationChain msgs) {
		StorageType oldValue = value;
		value = newValue;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TypePackage.ESTRING_TO_STORAGE_TYPE_MAP_ENTRY__VALUE, oldValue, newValue);
	 ...
	 * @generated
	 */
	public void setTypedValue(StorageType newValue) {
		if (newValue != value) {
			NotificationChain msgs = null;
			if (value != null)
				msgs = ((InternalEObject)value).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TypePackage.ESTRING_TO_STORAGE_TYPE_MAP_ENTRY__VALUE, null, msgs);
			if (newValue != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, TypePackage.ESTRING_TO_STORAGE_TYPE_MAP_ENTRY__VALUE, newValue, newValue));
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case TypePackage.ESTRING_TO_STORAGE_TYPE_MAP_ENTRY__KEY:
				...
				return;
			case TypePackage.ESTRING_TO_STORAGE_TYPE_MAP_ENTRY__VALUE:
				setTypedValue((StorageType)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case TypePackage.ESTRING_TO_STORAGE_TYPE_MAP_ENTRY__KEY:
				...
				return;
			case TypePackage.ESTRING_TO_STORAGE_TYPE_MAP_ENTRY__VALUE:
				setTypedValue((StorageType)null);
				return;
		}
	 ...
	 */
	@Override
	public StorageType setValue(StorageType value) {
		StorageType oldValue = getValue();
		setTypedValue(value);
		return oldValue;
	}
	...
	public EMap<String, StorageType> getEMap() {
		...
		return container == null ? null : (EMap<String, StorageType>)container.eGet(eContainmentFeature());
	}
