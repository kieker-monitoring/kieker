...
public class AssemblyModelImpl extends MinimalEObjectImpl.Container implements AssemblyModel {
	...
	public EMap<String, AssemblyComponent> getAssemblyComponents() {
		if (assemblyComponents == null) {
			assemblyComponents = new EcoreEMap<String, AssemblyComponent>(AssemblyPackage.Literals.ESTRING_TO_ASSEMBLY_COMPONENT_MAP_ENTRY,
					EStringToAssemblyComponentMapEntryImpl.class, this, AssemblyPackage.ASSEMBLY_MODEL__ASSEMBLY_COMPONENTS);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case AssemblyPackage.ASSEMBLY_MODEL__ASSEMBLY_COMPONENTS:
			if (coreType)
				...
				return getAssemblyComponents().map();
		}
