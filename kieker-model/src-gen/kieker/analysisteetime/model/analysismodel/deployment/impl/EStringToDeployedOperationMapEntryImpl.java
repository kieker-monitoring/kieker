 ...
 * </p>
 * <ul>
 * <li>{@link kieker.analysisteetime.model.analysismodel.deployment.impl.EStringToDeployedOperationMapEntryImpl#getTypedKey <em>Key</em>}</li>
 * <li>{@link kieker.analysisteetime.model.analysismodel.deployment.impl.EStringToDeployedOperationMapEntryImpl#getTypedValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EStringToDeployedOperationMapEntryImpl extends MinimalEObjectImpl.Container implements BasicEMap.Entry<String, DeployedOperation> {
	...
	public void setTypedKey(String newKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DeploymentPackage.ESTRING_TO_DEPLOYED_OPERATION_MAP_ENTRY__KEY, oldKey, key));
	}
