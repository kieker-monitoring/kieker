...
public class TestGeneratedBeforeOperationObjectInterfaceEvent extends AbstractGeneratedKiekerTest {
	...
	for (int i=0;i<ARRAY_LENGTH;i++) {
			// initialize
			BeforeOperationObjectInterfaceEvent record = new BeforeOperationObjectInterfaceEvent(LONG_VALUES[i%LONG_VALUES.length], LONG_VALUES[i%LONG_VALUES.length], INT_VALUES[i%INT_VALUES.length], STRING_VALUES[i%STRING_VALUES.length], STRING_VALUES[i%STRING_VALUES.length], INT_VALUES[i%INT_VALUES.length], STRING_VALUES[i%STRING_VALUES.length]);
			
			// check values
			Assert.assertEquals("BeforeOperationObjectInterfaceEvent.timestamp values are not equal.", LONG_VALUES[i%LONG_VALUES.length], record.getTimestamp());
			Assert.assertEquals("BeforeOperationObjectInterfaceEvent.traceId values are not equal.", LONG_VALUES[i%LONG_VALUES.length], record.getTraceId());
			Assert.assertEquals("BeforeOperationObjectInterfaceEvent.orderIndex values are not equal.", INT_VALUES[i%INT_VALUES.length], record.getOrderIndex());
			Assert.assertEquals("BeforeOperationObjectInterfaceEvent.classSignature values are not equal.", STRING_VALUES[i%STRING_VALUES.length] == null?"":STRING_VALUES[i%STRING_VALUES.length], record.getClassSignature());
			Assert.assertEquals("BeforeOperationObjectInterfaceEvent.operationSignature values are not equal.", STRING_VALUES[i%STRING_VALUES.length] == null?"":STRING_VALUES[i%STRING_VALUES.length], record.getOperationSignature());
			Assert.assertEquals("BeforeOperationObjectInterfaceEvent.objectId values are not equal.", INT_VALUES[i%INT_VALUES.length], record.getObjectId());
			Assert.assertEquals("BeforeOperationObjectInterfaceEvent.interface values are not equal.", STRING_VALUES[i%STRING_VALUES.length] == null?"":STRING_VALUES[i%STRING_VALUES.length], record.getInterface());
			...
			Assert.assertEquals("Array value [5] " + values[5] + " does not match the desired value " + INT_VALUES[i%INT_VALUES.length],
				INT_VALUES[i%INT_VALUES.length], (int) (Integer)values[5]
					);
