...
/**
 * Tests for kieker.common.record.flow.trace.operation.AfterOperationEvent records.
 * 
 * @author Reiner Jung
 * 
 * @since 1.10
...
public class TestAfterOperationEventPropertyOrder extends AbstractKiekerTest {
	...
	public void testAfterOperationEventPropertyOrder() { // NOPMD
		...
		final ByteBuffer inputBuffer = this.createByteBuffer(AfterOperationEvent.SIZE, 
		...
		final AfterOperationEvent recordInitParameter = new AfterOperationEvent(PROPERTY_TIMESTAMP, PROPERTY_TRACE_ID, PROPERTY_ORDER_INDEX, PROPERTY_OPERATION_SIGNATURE, PROPERTY_CLASS_SIGNATURE);
		final AfterOperationEvent recordInitBuffer = new AfterOperationEvent(inputBuffer, this.makeStringRegistry());
