...
/**
 * Tests for kieker.common.record.flow.trace.operation.AfterOperationFailedEvent records.
 * 
 * @author Reiner Jung
 * 
 * @since 1.10
 */
public class TestAfterOperationFailedEventPropertyOrder extends AbstractKiekerTest {
	 ...
	 * Empty constructor.
	 */
	public TestAfterOperationFailedEventPropertyOrder() {}

	/**
	 * Test property order processing of CPUUtilizationRecord constructors.
	 */
	@Test
	public void testAfterOperationFailedEventPropertyOrder() { // NOPMD
		final IRegistry<String> stringRegistry = this.makeStringRegistry();
		final ByteBuffer inputBuffer = this.createByteBuffer(AfterOperationFailedEvent.SIZE, 
			this.makeStringRegistry(),
			PROPERTY_TIMESTAMP, PROPERTY_TRACE_ID, PROPERTY_ORDER_INDEX, PROPERTY_OPERATION_SIGNATURE, PROPERTY_CLASS_SIGNATURE, PROPERTY_CAUSE);
		final Object[] values = { PROPERTY_TIMESTAMP, PROPERTY_TRACE_ID, PROPERTY_ORDER_INDEX, PROPERTY_OPERATION_SIGNATURE, PROPERTY_CLASS_SIGNATURE, PROPERTY_CAUSE };
					
		final AfterOperationFailedEvent recordInitParameter = new AfterOperationFailedEvent(PROPERTY_TIMESTAMP, PROPERTY_TRACE_ID, PROPERTY_ORDER_INDEX, PROPERTY_OPERATION_SIGNATURE, PROPERTY_CLASS_SIGNATURE, PROPERTY_CAUSE);
		...
		this.assertAfterOperationFailedEvent(recordInitBuffer);
		this.assertAfterOperationFailedEvent(recordInitArray);
	...
	/**
	 * Assertions for AfterOperationFailedEvent.
	 */
	private void assertAfterOperationFailedEvent(final AfterOperationFailedEvent record) {
