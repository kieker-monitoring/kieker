...
/**
 * Tests for kieker.common.record.flow.trace.concurrency.monitor.MonitorNotifyEvent records.
 * 
 * @author Reiner Jung
 * 
 * @since 1.10
...
public class TestMonitorNotifyEventPropertyOrder extends AbstractKiekerTest {
	...
	public void testMonitorNotifyEventPropertyOrder() { // NOPMD
		...
		final ByteBuffer inputBuffer = this.createByteBuffer(MonitorNotifyEvent.SIZE, 
		...
		final MonitorNotifyEvent recordInitParameter = new MonitorNotifyEvent(PROPERTY_TIMESTAMP, PROPERTY_TRACE_ID, PROPERTY_ORDER_INDEX, PROPERTY_LOCK_ID);
