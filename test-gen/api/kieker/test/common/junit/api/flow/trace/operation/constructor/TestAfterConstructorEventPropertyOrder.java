...
public class TestAfterConstructorEventPropertyOrder extends AbstractKiekerTest {
	...
	public void testAfterConstructorEventPropertyOrder() { // NOPMD
		...
		final ByteBuffer inputBuffer = UtilityAPITestFunctions.createByteBuffer(AfterConstructorEvent.SIZE, 
		...
		final AfterConstructorEvent recordInitBuffer = new AfterConstructorEvent(inputBuffer, this.makeStringRegistry());
