...
/**
 * Tests for kieker.common.record.flow.trace.concurrency.monitor.MonitorEntryEvent records.
 * 
 * @author Reiner Jung
 * 
 * @since 1.10
...
public class TestMonitorEntryEventPropertyOrder extends AbstractKiekerTest {
	...
	public void testMonitorEntryEventPropertyOrder() { // NOPMD
		...
		final ByteBuffer inputBuffer = this.createByteBuffer(MonitorEntryEvent.SIZE, 
		...
		final MonitorEntryEvent recordInitParameter = new MonitorEntryEvent(PROPERTY_TIMESTAMP, PROPERTY_TRACE_ID, PROPERTY_ORDER_INDEX, PROPERTY_LOCK_ID);
		final MonitorEntryEvent recordInitBuffer = new MonitorEntryEvent(inputBuffer, this.makeStringRegistry());
