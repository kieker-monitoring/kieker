...
/**
 * Tests for kieker.common.record.flow.trace.operation.CallOperationEvent records.
 * 
 * @author Reiner Jung
 * 
 * @since 1.10
...
public class TestCallOperationEventPropertyOrder extends AbstractKiekerTest {
	...
	public void testCallOperationEventPropertyOrder() { // NOPMD
		...
		final ByteBuffer inputBuffer = this.createByteBuffer(CallOperationEvent.SIZE, 
		...
		final CallOperationEvent recordInitParameter = new CallOperationEvent(PROPERTY_TIMESTAMP, PROPERTY_TRACE_ID, PROPERTY_ORDER_INDEX, PROPERTY_CALLER_OPERATION_SIGNATURE, PROPERTY_CALLER_CLASS_SIGNATURE, PROPERTY_CALLEE_OPERATION_SIGNATURE, PROPERTY_CALLEE_CLASS_SIGNATURE);
