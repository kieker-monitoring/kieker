...
/**
 * Tests for kieker.common.record.flow.trace.concurrency.monitor.MonitorNotifyAllEvent records.
 * 
 * @author Reiner Jung
 * 
 * @since 1.10
...
public class TestMonitorNotifyAllEventPropertyOrder extends AbstractKiekerTest {
	...
	public void testMonitorNotifyAllEventPropertyOrder() { // NOPMD
		...
		final ByteBuffer inputBuffer = this.createByteBuffer(MonitorNotifyAllEvent.SIZE, 
		...
		final MonitorNotifyAllEvent recordInitParameter = new MonitorNotifyAllEvent(PROPERTY_TIMESTAMP, PROPERTY_TRACE_ID, PROPERTY_ORDER_INDEX, PROPERTY_LOCK_ID);
