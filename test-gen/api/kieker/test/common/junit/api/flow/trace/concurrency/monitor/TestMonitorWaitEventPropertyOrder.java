...
/**
 * Tests for kieker.common.record.flow.trace.concurrency.monitor.MonitorWaitEvent records.
 * 
 * @author Reiner Jung
 * 
 * @since 1.10
...
public class TestMonitorWaitEventPropertyOrder extends AbstractKiekerTest {
	...
	public void testMonitorWaitEventPropertyOrder() { // NOPMD
		...
		final ByteBuffer inputBuffer = this.createByteBuffer(MonitorWaitEvent.SIZE, 
		...
		final MonitorWaitEvent recordInitParameter = new MonitorWaitEvent(PROPERTY_TIMESTAMP, PROPERTY_TRACE_ID, PROPERTY_ORDER_INDEX, PROPERTY_LOCK_ID);
