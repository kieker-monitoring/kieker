...
/**
 * Tests for kieker.common.record.flow.trace.operation.BeforeOperationEvent records.
 * 
 * @author Reiner Jung
 * 
 * @since 1.10
...
public class TestBeforeOperationEventPropertyOrder extends AbstractKiekerTest {
	...
	public void testBeforeOperationEventPropertyOrder() { // NOPMD
		...
		final ByteBuffer inputBuffer = this.createByteBuffer(BeforeOperationEvent.SIZE, 
		...
		final BeforeOperationEvent recordInitParameter = new BeforeOperationEvent(PROPERTY_TIMESTAMP, PROPERTY_TRACE_ID, PROPERTY_ORDER_INDEX, PROPERTY_OPERATION_SIGNATURE, PROPERTY_CLASS_SIGNATURE);
