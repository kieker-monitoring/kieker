...
\newcommand{\version}{1.12} % will be set automatically by ant 'release' target 
...
\newcommand{\mainJar}{kieker-1.12.jar} % will be set automatically by ant 'release' target
\newcommand{\mainJarEMF}{kieker-1.12-emf.jar} % will be set automatically by ant 'release' target
\newcommand{\mainJarWeaver}{kieker-1.12-aspectj.jar} % will be set automatically by ant 'release' target
