...
\newcommand{\version}{1.12-SNAPSHOT} % will be set automatically by ant 'release' target 
...
\newcommand{\mainJar}{kieker-1.12-SNAPSHOT.jar} % will be set automatically by ant 'release' target
\newcommand{\mainJarEMF}{kieker-1.12-SNAPSHOT-emf.jar} % will be set automatically by ant 'release' target
\newcommand{\mainJarWeaver}{kieker-1.12-SNAPSHOT-aspectj.jar} % will be set automatically by ant 'release' target
