...
\newcommand{\mainJarEMF}{kieker-1.11-SNAPSHOT-emf.jar} % will be set automatically by ant 'release' target
\newcommand{\mainJarWeaver}{kieker-1.11-SNAPSHOT-aspectj.jar} % will be set automatically by ant 'release' target
