...
\newcommand{\mainJar}{kieker-1.11.jar} % will be set automatically by ant 'release' target
\newcommand{\mainJarEMF}{kieker-1.11-emf.jar} % will be set automatically by ant 'release' target
\newcommand{\mainJarWeaver}{kieker-1.11-aspectj.jar} % will be set automatically by ant 'release' target
