...
#\lstshellprompt{}# #\textbf{./gradlew}# run-monitoring
\end{lstlisting}
\begin{lstlisting}[caption=Start of the monitoring under Windows]
#\lstshellprompt{}# #\textbf{gradlew.bat}# run-monitoring
\end{lstlisting}
...
#\lstshellprompt{}# #\textbf{./gradlew}# run-analysis #\textbf{-Danalysis.directory}#=</path/to/monitoring/log/>
\end{lstlisting}
\begin{lstlisting}[caption=Start of the monitoring data analysis under Windows]
#\lstshellprompt{}# #\textbf{gradlew.bat}# run-analysis #\textbf{-Danalysis.directory}#=</path/to/monitoring/log/>
\end{lstlisting}
