 ...
 * @since 1.14
 */
public class BZip2CompressionFilter implements ICompressionFilter {
	 ...
	 */
	public BZip2CompressionFilter(final Configuration configuration) { // NOPMD block warning of unused configuration parameter
