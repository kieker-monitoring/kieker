...
public final class Version {
	...
	private static final String VERSION = "2.0.3-SNAPSHOT"; // NOPMD (name equals classname)

	private static final String COPYRIGHT = "Copyright (c) 2006-2026 Kieker Project";
