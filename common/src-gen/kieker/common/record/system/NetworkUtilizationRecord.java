...
public class NetworkUtilizationRecord extends AbstractMonitoringRecord {
	...
	public boolean equals(final Object obj) {
		...
		if ((this.getLoggingTimestamp() != castedRecord.getLoggingTimestamp()) || (this.getTimestamp() != castedRecord.getTimestamp()) || !this.getHostname().equals(castedRecord.getHostname()) || !this.getInterfaceName().equals(castedRecord.getInterfaceName())) {
			return false;
		}
