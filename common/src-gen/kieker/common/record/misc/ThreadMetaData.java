...
public class ThreadMetaData extends AbstractMonitoringRecord {
	...
	public boolean equals(final Object obj) {
		...
		if ((this.getLoggingTimestamp() != castedRecord.getLoggingTimestamp()) || !this.getHostname().equals(castedRecord.getHostname()) || (this.getThreadId() != castedRecord.getThreadId())) {
			return false;
		}
