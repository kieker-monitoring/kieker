...
public class BeforeReceivedRemoteEvent extends AbstractMonitoringRecord {
	...
	public boolean equals(final Object obj) {
		...
		if ((this.getLoggingTimestamp() != castedRecord.getLoggingTimestamp()) || (this.getTimestamp() != castedRecord.getTimestamp()) || (this.getCallerTraceId() != castedRecord.getCallerTraceId()) || (this.getCallerOrderIndex() != castedRecord.getCallerOrderIndex())) {
			return false;
		}
