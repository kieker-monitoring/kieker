...
public class BranchingRecord extends AbstractMonitoringRecord {
	...
	public boolean equals(final Object obj) {
		...
		if ((this.getLoggingTimestamp() != castedRecord.getLoggingTimestamp()) || (this.getTimestamp() != castedRecord.getTimestamp()) || (this.getBranchID() != castedRecord.getBranchID()) || (this.getBranchingOutcome() != castedRecord.getBranchingOutcome())) {
			return false;
		}
