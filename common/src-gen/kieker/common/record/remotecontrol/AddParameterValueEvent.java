...
public class AddParameterValueEvent extends AbstractMonitoringRecord implements IParameterValueEvent {
	...
	public boolean equals(final Object obj) {
		...
		if ((this.getLoggingTimestamp() != castedRecord.getLoggingTimestamp()) || !this.getPattern().equals(castedRecord.getPattern()) || !this.getName().equals(castedRecord.getName()) || !this.getValue().equals(castedRecord.getValue())) {
			return false;
		}
