...
public enum GraphOrderType {
	...
	@XmlEnumValue("free")
	FREE("free"), @XmlEnumValue("nodesfirst")
	NODESFIRST("nodesfirst"), @XmlEnumValue("adjacencylist")
	ADJACENCYLIST("adjacencylist");

	private final String value;

	GraphOrderType(final String v) {
		this.value = v;
	}
	...
	public static GraphOrderType fromValue(final String v) {
		for (final GraphOrderType c : GraphOrderType.values()) {
			if (c.value.equals(v)) {
				return c;
			}
		}
