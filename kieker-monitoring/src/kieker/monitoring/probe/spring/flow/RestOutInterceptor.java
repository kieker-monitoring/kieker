...
public class RestOutInterceptor implements ClientHttpRequestInterceptor {
    ...
    public ClientHttpResponse intercept(final HttpRequest request, final byte[] body, final ClientHttpRequestExecution execution) throws IOException {
        ...
        headers.add(RestConstants.HEADER_FIELD, Long.toString(traceId) + "," + sessionId + "," + Integer.toString(eoi) + "," + Integer.toString(nextESS));
        ...
        try {
            ...
            CTRLINST.newMonitoringRecord(new OperationExecutionRecord(RestOutInterceptor.SIGNATURE, sessionId, traceId, tin, tout, VMNAME, eoi, ess));
            // cleanup
            if (entrypoint) {
