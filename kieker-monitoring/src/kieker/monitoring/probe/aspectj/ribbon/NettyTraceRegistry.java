 ...
 * @since 1.0
 */
public final class NettyTraceRegistry {
	private static final Log LOG = LogFactory.getLog(NettyTraceRegistry.class);

	private static final NettyTraceRegistry INSTANCE = new NettyTraceRegistry();
	 ...
	 */
	public static final NettyTraceRegistry getInstance() {
		synchronized (NettyTraceRegistry.class) {
			return INSTANCE;
		}
	}
