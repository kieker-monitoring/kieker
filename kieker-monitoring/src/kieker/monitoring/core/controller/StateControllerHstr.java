 ...
 * @since 1.3
 */
public final class StateControllerHstr extends AbstractController implements IStateController {
	private static final Log LOG = LogFactory.getLog(StateControllerHstr.class);
	 ...
	 */
	protected StateControllerHstr(final Configuration configuration) {
		super(configuration);
