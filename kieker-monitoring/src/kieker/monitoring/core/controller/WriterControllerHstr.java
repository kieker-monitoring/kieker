 ...
 * @since 1.3
 */
public final class WriterControllerHstr extends AbstractController implements IWriterController, IStateListener {

	private static final Log LOG = LogFactory.getLog(WriterControllerHstr.class);

	public static final String PREFIX = WriterControllerHstr.class.getName() + ".";
	 ...
	 */
	public WriterControllerHstr(final Configuration configuration) {
		super(configuration);
