 ...
 * @since 1.14
 */
public class GenericTextFileWriterTest {
	...
	public GenericTextFileWriterTest() {
		super();
	}
	...
	public void before() {
		...
		this.configuration.setProperty(FileWriter.CONFIG_LOG_STREAM_HANDLER, TextLogStreamHandler.class.getName());
