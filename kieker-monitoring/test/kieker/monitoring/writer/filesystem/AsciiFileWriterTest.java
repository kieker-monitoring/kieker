...
public class AsciiFileWriterTest {
	...
	public void shouldCreateLogFolder() {
		...
		this.configuration.setProperty(AsciiFileWriter.CONFIG_COMPRESSION_METHOD, ECompression.NONE.getMethodName());
	...
	public void shouldCreateMultipleCompressedRecordFiles() {
		// test preparation
		this.configuration.setProperty(AsciiFileWriter.CONFIG_MAXENTRIESINFILE, "2");
		this.configuration.setProperty(AsciiFileWriter.CONFIG_COMPRESSION_METHOD, ECompression.ZIP.getMethodName());
