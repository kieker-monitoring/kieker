...
public class BeforeOperationObjectEvent extends BeforeOperationEvent implements IObjectRecord {
	 ...
	 *            objectId
	 */
	public BeforeOperationObjectEvent(final long timestamp, final long traceId, final int orderIndex, final String classSignature, final String operationSignature, final int objectId) {
