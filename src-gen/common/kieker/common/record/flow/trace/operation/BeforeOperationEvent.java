 ...
 * @since 1.10
 */
public class BeforeOperationEvent extends AbstractOperationEvent implements IMonitoringRecord.Factory, IMonitoringRecord.BinaryFactory {
	 ...
	 *            operationSignature
	 */
	public BeforeOperationEvent(final long timestamp, final long traceId, final int orderIndex, final String classSignature, final String operationSignature) {
