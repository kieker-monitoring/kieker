...
public class CallConstructorObjectEvent extends CallConstructorEvent implements IMonitoringRecord.Factory, IMonitoringRecord.BinaryFactory, ICallObjectRecord {
	...
	private static final long serialVersionUID = 5183834679769561474L;
	...
	private static final Class<?>[] TYPES = {
		...
		Integer.class, // ICallObjectRecord.callerObjectId
	 ...
	 *            calleeObjectId
	 */
	public CallConstructorObjectEvent(final long timestamp, final long traceId, final int orderIndex, final String classSignature, final String operationSignature, final String calleeClassSignature, final String calleeOperationSignature, final int objectId, final int callerObjectId, final int calleeObjectId) {
	...
	public CallConstructorObjectEvent(final Object[] values) { // NOPMD (direct store of values)
		...
		this.callerObjectId = (Integer) values[8];
		this.calleeObjectId = (Integer) values[9];
	}
