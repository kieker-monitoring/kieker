 ...
 * @since 1.10
 */
public class AfterConstructorFailedEvent extends AfterOperationFailedEvent implements IMonitoringRecord.Factory, IMonitoringRecord.BinaryFactory, IConstructorRecord {
	 ...
	 *            cause
	 */
	public AfterConstructorFailedEvent(final long timestamp, final long traceId, final int orderIndex, final String classSignature, final String operationSignature, final String cause) {
