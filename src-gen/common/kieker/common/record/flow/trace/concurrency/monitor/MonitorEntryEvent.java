 ...
 * @since 1.10
 */
public class MonitorEntryEvent extends AbstractMonitorEvent implements IMonitoringRecord.Factory, IMonitoringRecord.BinaryFactory {
	 ...
	 */
	public MonitorEntryEvent(final ByteBuffer buffer, final IRegistry<String> stringRegistry) throws BufferUnderflowException {
