 ...
 * @since 1.6
 */
public class TestBeforeOperationEvent extends AbstractKickerTest {
	...
	public void testSerializeDeserializeEquals() {
		...
		final BeforeOperationEvent event1 =
				new BeforeOperationEvent(TSTAMP, TRACE_ID, ORDER_INDEX, FQ_OPERATION_SIGNATURE, FQ_CLASSNAME);
	...
	public void testSerializeDeserializeBinaryEquals() {
		...
		final BeforeOperationEvent event2 = new BeforeOperationEvent(buffer, stringRegistry);
