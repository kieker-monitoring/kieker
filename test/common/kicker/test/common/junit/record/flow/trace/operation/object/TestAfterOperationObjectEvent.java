 ...
 * @since 1.6
 */
public class TestAfterOperationObjectEvent extends AbstractKickerTest {
	...
	public void testSerializeDeserializeEquals() {
		...
		final AfterOperationObjectEvent event1 =
				new AfterOperationObjectEvent(TSTAMP, TRACE_ID, ORDER_INDEX, FQ_OPERATION_SIGNATURE, FQ_CLASSNAME, OBJECT_ID);
	...
	public void testSerializeDeserializeBinaryEquals() {
		...
		final AfterOperationObjectEvent event2 = new AfterOperationObjectEvent(buffer, stringRegistry);
