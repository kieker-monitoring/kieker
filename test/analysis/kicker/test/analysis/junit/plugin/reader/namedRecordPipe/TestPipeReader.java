...
package kicker.test.analysis.junit.plugin.reader.namedRecordPipe;
...
import kicker.test.common.util.namedRecordPipe.NamedPipeWriterFactory;
 ...
 * @since 1.4
 */
public class TestPipeReader extends AbstractKickerTest { // NOCS (MissingCtorCheck)
