...
public class TestThreadsStatusSampler extends AbstractJVMSamplerTest {
	...
	private final static String LISTNAME = TestThreadsStatusSampler.class.getName();
	private final static String SIGNATURE = SignatureFactory.createJVMThreadsSignature();
	private final static ThreadsStatusSampler SAMPLER = new ThreadsStatusSampler();
