 ...
 * @since 1.10
 */
public class TestCompilationSampler extends AbstractKiekerTest {
	...
	@Before
	public void prepare() {
		this.listName = TestCompilationSampler.class.getName();
	...
	public void testAdaptiveMonitoring() throws InterruptedException {
		...
		final CompilationSampler sampler = new CompilationSampler();
		...
		final String pattern = SignatureFactory.createJVMCompilationSignature();
		...
		final boolean isInstanceOf = this.recordListFilledByListWriter.get(0) instanceof CompilationRecord;
