 ...
 * {@link IMonitoringController}. Also, the {@link kicker.analysis.plugin.reader.namedRecordPipe.PipeReader} is used.
 * 
...
public final class NamedPipeFactory {
	...
	/**
	 * Creates an {@link kicker.monitoring.writer.IMonitoringWriter} that collects records from a {@link Pipe} and collects these in the returned {@link List}.
	 * 
	 * @param pipeName
	 *            The name of the pipe to use.
