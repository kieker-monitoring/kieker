 ...
 * @since 1.8
 */
public class TestCXFClientServerInterceptors extends AbstractKickerTest {
	...
	public final void testIt() throws InterruptedException {
		...
		final String clientPattern = "public void kicker.monitoring.probe.cxf.OperationExecutionSOAPResponseInInterceptor.handleMessage(org.apache.cxf.message.Message)";
		final String serverPattern = "public void kicker.monitoring.probe.cxf.OperationExecutionSOAPResponseOutInterceptor.handleMessage(org.apache.cxf.binding.soap.SoapMessage)";
	...
	private void unsetKickerThreadLocalData() {
