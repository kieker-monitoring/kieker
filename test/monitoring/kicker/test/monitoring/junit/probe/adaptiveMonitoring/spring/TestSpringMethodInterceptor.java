 ...
 * @since 1.8
 */
public class TestSpringMethodInterceptor extends AbstractKickerTest {
	...
	public void startServer() throws IOException {
		...
		// Doesn't work because property not starting with kicker.monitoring: System.setProperty(NamedListWriter.CONFIG_PROPERTY_NAME_LIST_NAME, this.listName);
		System.setProperty(ConfigurationFactory.HOST_NAME, HOSTNAME);

		// start the server
		this.ctx = new FileSystemXmlApplicationContext("test/monitoring/kicker/test/monitoring/junit/probe/spring/executions/jetty/jetty.xml");

		// Note that the Spring interceptor is configure in
		// test/monitoring/kicker/test/monitoring/junit/probe/spring/executions/jetty/webapp/WEB-INF/spring/servlet-context.xml to only instrument
	...
	public void testIt() throws IOException {
		...
		final String getBookPattern = "public kicker.test.monitoring.junit.probe.spring.executions.jetty.bookstore.Book kicker.test.monitoring.junit.probe.spring.executions.jetty.bookstore.Catalog.getBook(boolean)";
		final String searchBookPattern = "public kicker.test.monitoring.junit.probe.spring.executions.jetty.bookstore.Book kicker.test.monitoring.junit.probe.spring.executions.jetty.bookstore.Bookstore.searchBook(java.lang.String)";
