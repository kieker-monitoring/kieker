...
import kicker.monitoring.writer.filesystem.AsyncBinaryNFsWriter;
 ...
 * @since 1.9
 */
public class BasicAsyncBinaryNFSWriterReaderTest extends AbstractTestFSWriterReader { // NOPMD (TestClassWithoutTestCases) // NOCS (MissingCtorCheck)

	@Override
	protected Class<? extends IMonitoringWriter> getTestedWriterClazz() {
		return AsyncBinaryNFsWriter.class;
	}
