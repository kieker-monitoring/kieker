 ...
 * @since 1.8
 */
public class TestServiceContainer extends AbstractKickerTest {
	...
	public void testServiceConnectorInterface() throws IOException, ConnectorDataTransmissionException {
		...
		// logDirs should contain one Kicker records folders.
		...
		Assert.assertTrue("The first entry must be the kicker directory.", logDirs[0].isDirectory());
		...
		// The result contains 20 data records, 1 record containing the version field and 1 kicker map file
