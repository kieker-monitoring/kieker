...
public final class RecordConverterTest extends AbstractKiekerTest {
	 ...
	 * @throws Exception throws exceptions that are thrown while setting up the filter structure
	 */
	@Before
	 ...
	 * @param oer
	 * @throws IllegalStateException exception that can possibly be thrown by AnalysisController
	 * @throws AnalysisConfigurationException exception that can possibly be thrown by AnalysisController
	 */
