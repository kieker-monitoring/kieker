...
public class Settings { // NOPMD data class
	...
	@Parameter(names = { "-s",
		"--signature-extractor" }, required = true, converter = ESignatureExtractorConverter.class,
			description = "Type of extractor used for component and operation signatures: elf, python, java")
	...
	@Parameter(names = { "-m",
		"--module-modes" }, required = true, variableArity = true, converter = EModuleModeConverter.class,
			description = "Module converter strategies: file-mode, map-mode, module-mode, java-class-mode, java-class-long-mode")
