...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>TN Type</b></em>'. <!--
 * end-user-doc -->
 * <p>
...
public class TNTypeImpl extends MinimalEObjectImpl.Container implements TNType {
    ...
    public FeatureMap getMixed() {
        if (this.mixed == null) {
            this.mixed = new BasicFeatureMap(this, FxtranPackage.TN_TYPE__MIXED);
        }
        return this.mixed;
    }
    ...
    public EList<NType> getN() {
        return this.getMixed().list(FxtranPackage.eINSTANCE.getTNType_N());
    }
