...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>AStmt Type</b></em>'. <!--
 * end-user-doc -->
 * <p>
...
public class AStmtTypeImpl extends MinimalEObjectImpl.Container implements AStmtType {
    ...
    public NotificationChain basicSetE1(final E1Type newE1, NotificationChain msgs) {
        ...
        if (this.eNotificationRequired()) {
            final ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FxtranPackage.ASTMT_TYPE__E1, oldE1, newE1);
            if (msgs == null) {
                msgs = notification;
            } else {
        ...
        if (newE1 != this.e1) {
            ...
            if (this.e1 != null) {
                msgs = ((InternalEObject) this.e1).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FxtranPackage.ASTMT_TYPE__E1, null, msgs);
            }
            if (newE1 != null) {
            ...
            this.eNotify(new ENotificationImpl(this, Notification.SET, FxtranPackage.ASTMT_TYPE__E1, newE1, newE1));
        }
    }
    ...
    public void setA(final String newA) {
        ...
        this.a = newA;
        if (this.eNotificationRequired()) {
            this.eNotify(new ENotificationImpl(this, Notification.SET, FxtranPackage.ASTMT_TYPE__A, oldA, this.a));
        }
    }
    ...
    public NotificationChain basicSetE2(final E2Type newE2, NotificationChain msgs) {
        ...
        if (this.eNotificationRequired()) {
            final ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FxtranPackage.ASTMT_TYPE__E2, oldE2, newE2);
            if (msgs == null) {
                msgs = notification;
            } else {
                msgs.add(notification);
        ...
        if (newE2 != this.e2) {
            ...
            if (this.e2 != null) {
                msgs = ((InternalEObject) this.e2).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FxtranPackage.ASTMT_TYPE__E2, null, msgs);
            }
            if (newE2 != null) {
            ...
            this.eNotify(new ENotificationImpl(this, Notification.SET, FxtranPackage.ASTMT_TYPE__E2, newE2, newE2));
        }
    }
