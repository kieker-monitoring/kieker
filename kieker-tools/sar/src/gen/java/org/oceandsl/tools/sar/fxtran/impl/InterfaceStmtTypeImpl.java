...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Interface Stmt
...
public class InterfaceStmtTypeImpl extends MinimalEObjectImpl.Container implements InterfaceStmtType {
    ...
    public FeatureMap getMixed() {
        if (this.mixed == null) {
            this.mixed = new BasicFeatureMap(this, FxtranPackage.INTERFACE_STMT_TYPE__MIXED);
        }
        return this.mixed;
    }
    ...
    public EList<NType> getN() {
        return this.getMixed().list(FxtranPackage.eINSTANCE.getInterfaceStmtType_N());
    }
