...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Case EType</b></em>'. <!--
 * end-user-doc -->
 * <p>
    ...
    public NotificationChain basicSetNamedE(final NamedEType newNamedE, NotificationChain msgs) {
        ...
        if (this.eNotificationRequired()) {
            final ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FxtranPackage.CASE_ETYPE__NAMED_E, oldNamedE, newNamedE);
            if (msgs == null) {
                msgs = notification;
            } else {
        ...
        if (newNamedE != this.namedE) {
            ...
            if (this.namedE != null) {
                msgs = ((InternalEObject) this.namedE).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FxtranPackage.CASE_ETYPE__NAMED_E, null, msgs);
            }
            if (newNamedE != null) {
            ...
            this.eNotify(new ENotificationImpl(this, Notification.SET, FxtranPackage.CASE_ETYPE__NAMED_E, newNamedE,
                    newNamedE));
        }
    }
