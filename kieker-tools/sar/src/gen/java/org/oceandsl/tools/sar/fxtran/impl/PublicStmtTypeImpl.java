...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Public Stmt Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class PublicStmtTypeImpl extends MinimalEObjectImpl.Container implements PublicStmtType {
    ...
    public FeatureMap getMixed() {
        if (this.mixed == null) {
            this.mixed = new BasicFeatureMap(this, FxtranPackage.PUBLIC_STMT_TYPE__MIXED);
        }
        return this.mixed;
    }
    ...
    public EList<ENLTType> getENLT() {
        return this.getMixed().list(FxtranPackage.eINSTANCE.getPublicStmtType_ENLT());
    }
    ...
    public NotificationChain eInverseRemove(final InternalEObject otherEnd, final int featureID,
        ...
        case FxtranPackage.PUBLIC_STMT_TYPE__ENLT:
            return ((InternalEList<?>) this.getENLT()).basicRemove(otherEnd, msgs);
        }
    ...
    public void eSet(final int featureID, final Object newValue) {
        ...
        case FxtranPackage.PUBLIC_STMT_TYPE__ENLT:
            this.getENLT().clear();
            this.getENLT().addAll((Collection<? extends ENLTType>) newValue);
            return;
        }
