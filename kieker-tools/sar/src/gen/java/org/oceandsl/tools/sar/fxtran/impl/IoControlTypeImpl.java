...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Io Control Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * <li>{@link org.oceandsl.tools.sar.fxtran.impl.IoControlTypeImpl#getLiteralE <em>Literal
 * E</em>}</li>
 * <li>{@link org.oceandsl.tools.sar.fxtran.impl.IoControlTypeImpl#getNamedE <em>Named E</em>}</li>
 * <li>{@link org.oceandsl.tools.sar.fxtran.impl.IoControlTypeImpl#getStringE <em>String
 * E</em>}</li>
 * </ul>
 *
 * @generated
...
public class IoControlTypeImpl extends MinimalEObjectImpl.Container implements IoControlType {
    ...
    public FeatureMap getMixed() {
        if (this.mixed == null) {
            this.mixed = new BasicFeatureMap(this, FxtranPackage.IO_CONTROL_TYPE__MIXED);
        }
        return this.mixed;
    }
    ...
    public FeatureMap getGroup() {
        return (FeatureMap) this.getMixed().<FeatureMap.Entry> list(FxtranPackage.eINSTANCE.getIoControlType_Group());
    }
    ...
    public EList<ArgNType> getArgN() {
        return this.getGroup().list(FxtranPackage.eINSTANCE.getIoControlType_ArgN());
    }
    ...
    public EList<LabelType> getLabel() {
        return this.getGroup().list(FxtranPackage.eINSTANCE.getIoControlType_Label());
    }
    ...
    public EList<LiteralEType> getLiteralE() {
        return this.getGroup().list(FxtranPackage.eINSTANCE.getIoControlType_LiteralE());
    }
    ...
    public EList<NamedEType> getNamedE() {
        return this.getGroup().list(FxtranPackage.eINSTANCE.getIoControlType_NamedE());
    }
    ...
    public EList<StringEType> getStringE() {
        return this.getGroup().list(FxtranPackage.eINSTANCE.getIoControlType_StringE());
    }
