...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Condition EType</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class ConditionETypeImpl extends MinimalEObjectImpl.Container implements ConditionEType {
    ...
    public NotificationChain basicSetNamedE(final NamedEType newNamedE, NotificationChain msgs) {
        ...
        if (this.eNotificationRequired()) {
            final ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FxtranPackage.CONDITION_ETYPE__NAMED_E, oldNamedE, newNamedE);
            if (msgs == null) {
                msgs = notification;
            } else {
        ...
        if (newNamedE != this.namedE) {
            ...
            if (this.namedE != null) {
                msgs = ((InternalEObject) this.namedE).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FxtranPackage.CONDITION_ETYPE__NAMED_E, null, msgs);
            }
            if (newNamedE != null) {
            ...
            this.eNotify(new ENotificationImpl(this, Notification.SET, FxtranPackage.CONDITION_ETYPE__NAMED_E,
                    newNamedE, newNamedE));
        }
    }
    ...
    public NotificationChain basicSetOpE(final OpEType newOpE, NotificationChain msgs) {
        ...
        if (this.eNotificationRequired()) {
            final ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FxtranPackage.CONDITION_ETYPE__OP_E, oldOpE, newOpE);
            if (msgs == null) {
                msgs = notification;
            } else {
                msgs.add(notification);
        ...
        if (newOpE != this.opE) {
            ...
            if (this.opE != null) {
                msgs = ((InternalEObject) this.opE).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FxtranPackage.CONDITION_ETYPE__OP_E, null, msgs);
            }
            if (newOpE != null) {
            ...
            this.eNotify(
                    new ENotificationImpl(this, Notification.SET, FxtranPackage.CONDITION_ETYPE__OP_E, newOpE, newOpE));
        }
    }
