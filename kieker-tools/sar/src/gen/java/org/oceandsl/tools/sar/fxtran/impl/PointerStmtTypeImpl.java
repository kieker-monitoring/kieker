...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Pointer Stmt
 ...
 * <li>{@link org.oceandsl.tools.sar.fxtran.impl.PointerStmtTypeImpl#getENDeclLT <em>EN Decl
 * LT</em>}</li>
 * </ul>
 *
 * @generated
...
public class PointerStmtTypeImpl extends MinimalEObjectImpl.Container implements PointerStmtType {
    ...
    public FeatureMap getMixed() {
        if (this.mixed == null) {
            this.mixed = new BasicFeatureMap(this, FxtranPackage.POINTER_STMT_TYPE__MIXED);
        }
        return this.mixed;
    }
    ...
    public EList<ENDeclLTType> getENDeclLT() {
        return this.getMixed().list(FxtranPackage.eINSTANCE.getPointerStmtType_ENDeclLT());
    }
