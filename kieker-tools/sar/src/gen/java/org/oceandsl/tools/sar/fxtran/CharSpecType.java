...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Char Spec Type</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
...
public interface CharSpecType extends EObject {
    ...
    /**
     * Returns the value of the '<em><b>Star E</b></em>' attribute list. The list contents are of
     ...
     *        volatile="true" derived="true" extendedMetaData="kind='element' name='star-E'
