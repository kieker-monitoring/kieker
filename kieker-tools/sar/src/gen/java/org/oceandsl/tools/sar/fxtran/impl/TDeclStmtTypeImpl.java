...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>TDecl Stmt Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * <li>{@link org.oceandsl.tools.sar.fxtran.impl.TDeclStmtTypeImpl#getENDeclLT <em>EN Decl
 * LT</em>}</li>
 * <li>{@link org.oceandsl.tools.sar.fxtran.impl.TDeclStmtTypeImpl#getTSpec <em>TSpec</em>}</li>
 * <li>{@link org.oceandsl.tools.sar.fxtran.impl.TDeclStmtTypeImpl#getAttribute
 * <em>Attribute</em>}</li>
 * </ul>
 *
 * @generated
...
public class TDeclStmtTypeImpl extends MinimalEObjectImpl.Container implements TDeclStmtType {
    ...
    public FeatureMap getMixed() {
        if (this.mixed == null) {
            this.mixed = new BasicFeatureMap(this, FxtranPackage.TDECL_STMT_TYPE__MIXED);
        }
        return this.mixed;
    }
    ...
    public FeatureMap getGroup() {
        return (FeatureMap) this.getMixed().<FeatureMap.Entry> list(FxtranPackage.eINSTANCE.getTDeclStmtType_Group());
    }
    ...
    public EList<ENDeclLTType> getENDeclLT() {
        return this.getGroup().list(FxtranPackage.eINSTANCE.getTDeclStmtType_ENDeclLT());
    }
    ...
    public EList<TSpecType> getTSpec() {
        return this.getGroup().list(FxtranPackage.eINSTANCE.getTDeclStmtType_TSpec());
    }
    ...
    public EList<AttributeType> getAttribute() {
        return this.getGroup().list(FxtranPackage.eINSTANCE.getTDeclStmtType_Attribute());
    }
