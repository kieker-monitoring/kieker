...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Cycle Stmt Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class CycleStmtTypeImpl extends MinimalEObjectImpl.Container implements CycleStmtType {
    ...
    public FeatureMap getMixed() {
        if (this.mixed == null) {
            this.mixed = new BasicFeatureMap(this, FxtranPackage.CYCLE_STMT_TYPE__MIXED);
        }
        return this.mixed;
    }
    ...
    public EList<NType> getN() {
        return this.getMixed().list(FxtranPackage.eINSTANCE.getCycleStmtType_N());
    }
