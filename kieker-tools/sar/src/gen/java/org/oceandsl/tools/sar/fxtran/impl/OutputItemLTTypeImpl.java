...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Output Item LT
 ...
 * <li>{@link org.oceandsl.tools.sar.fxtran.impl.OutputItemLTTypeImpl#getOutputItem <em>Output
 * Item</em>}</li>
 * </ul>
 *
 * @generated
...
public class OutputItemLTTypeImpl extends MinimalEObjectImpl.Container implements OutputItemLTType {
    ...
    public FeatureMap getMixed() {
        if (this.mixed == null) {
            this.mixed = new BasicFeatureMap(this, FxtranPackage.OUTPUT_ITEM_LT_TYPE__MIXED);
        }
        return this.mixed;
    }
    ...
    public EList<OutputItemType> getOutputItem() {
        return this.getMixed().list(FxtranPackage.eINSTANCE.getOutputItemLTType_OutputItem());
    }
    ...
    public NotificationChain eInverseRemove(final InternalEObject otherEnd, final int featureID,
        ...
        case FxtranPackage.OUTPUT_ITEM_LT_TYPE__OUTPUT_ITEM:
            return ((InternalEList<?>) this.getOutputItem()).basicRemove(otherEnd, msgs);
        }
    ...
    public void eSet(final int featureID, final Object newValue) {
        ...
        case FxtranPackage.OUTPUT_ITEM_LT_TYPE__MIXED:
            ...
            return;
        case FxtranPackage.OUTPUT_ITEM_LT_TYPE__OUTPUT_ITEM:
            this.getOutputItem().clear();
            this.getOutputItem().addAll((Collection<? extends OutputItemType>) newValue);
            return;
        }
    ...
    public boolean eIsSet(final int featureID) {
        ...
        case FxtranPackage.OUTPUT_ITEM_LT_TYPE__OUTPUT_ITEM:
            return !this.getOutputItem().isEmpty();
        }
