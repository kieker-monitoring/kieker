...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Arg Spec Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class ArgSpecTypeImpl extends MinimalEObjectImpl.Container implements ArgSpecType {
    ...
    public FeatureMap getMixed() {
        if (this.mixed == null) {
            this.mixed = new BasicFeatureMap(this, FxtranPackage.ARG_SPEC_TYPE__MIXED);
        }
        return this.mixed;
    }
    ...
    public FeatureMap getGroup() {
        return (FeatureMap) this.getMixed().<FeatureMap.Entry> list(FxtranPackage.eINSTANCE.getArgSpecType_Group());
    }
    ...
    public EList<String> getCnt() {
        return this.getGroup().list(FxtranPackage.eINSTANCE.getArgSpecType_Cnt());
    }
    ...
    public EList<ArgType> getArg() {
        return this.getGroup().list(FxtranPackage.eINSTANCE.getArgSpecType_Arg());
    }
    ...
    public NotificationChain eInverseRemove(final InternalEObject otherEnd, final int featureID,
        ...
        case FxtranPackage.ARG_SPEC_TYPE__ARG:
            return ((InternalEList<?>) this.getArg()).basicRemove(otherEnd, msgs);
        }
    ...
    public void eSet(final int featureID, final Object newValue) {
        ...
        case FxtranPackage.ARG_SPEC_TYPE__ARG:
            this.getArg().clear();
            this.getArg().addAll((Collection<? extends ArgType>) newValue);
            return;
        }
