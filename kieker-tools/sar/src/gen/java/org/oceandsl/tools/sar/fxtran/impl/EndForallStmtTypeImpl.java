...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>End Forall Stmt
...
public class EndForallStmtTypeImpl extends MinimalEObjectImpl.Container implements EndForallStmtType {
    ...
    public FeatureMap getMixed() {
        if (this.mixed == null) {
            this.mixed = new BasicFeatureMap(this, FxtranPackage.END_FORALL_STMT_TYPE__MIXED);
        }
        return this.mixed;
    }
    ...
    public EList<NType> getN() {
        return this.getMixed().list(FxtranPackage.eINSTANCE.getEndForallStmtType_N());
    }
