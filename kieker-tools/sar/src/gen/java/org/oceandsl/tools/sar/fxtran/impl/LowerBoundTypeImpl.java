...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Lower Bound Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.oceandsl.tools.sar.fxtran.impl.LowerBoundTypeImpl#getLiteralE <em>Literal
 * E</em>}</li>
...
public class LowerBoundTypeImpl extends MinimalEObjectImpl.Container implements LowerBoundType {
    ...
    public NotificationChain basicSetLiteralE(final LiteralEType newLiteralE, NotificationChain msgs) {
        ...
        if (this.eNotificationRequired()) {
            final ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FxtranPackage.LOWER_BOUND_TYPE__LITERAL_E, oldLiteralE, newLiteralE);
            if (msgs == null) {
                msgs = notification;
            } else {
        ...
        if (newLiteralE != this.literalE) {
            ...
            if (this.literalE != null) {
                msgs = ((InternalEObject) this.literalE).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FxtranPackage.LOWER_BOUND_TYPE__LITERAL_E, null, msgs);
            }
            if (newLiteralE != null) {
            ...
            this.eNotify(new ENotificationImpl(this, Notification.SET, FxtranPackage.LOWER_BOUND_TYPE__LITERAL_E,
    ...
    public NotificationChain basicSetNamedE(final NamedEType newNamedE, NotificationChain msgs) {
        ...
        if (this.eNotificationRequired()) {
            final ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FxtranPackage.LOWER_BOUND_TYPE__NAMED_E, oldNamedE, newNamedE);
            if (msgs == null) {
                msgs = notification;
            } else {
                msgs.add(notification);
        ...
        if (newNamedE != this.namedE) {
            ...
            if (this.namedE != null) {
                msgs = ((InternalEObject) this.namedE).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FxtranPackage.LOWER_BOUND_TYPE__NAMED_E, null, msgs);
            }
            if (newNamedE != null) {
            ...
            this.eNotify(new ENotificationImpl(this, Notification.SET, FxtranPackage.LOWER_BOUND_TYPE__NAMED_E,
                    newNamedE, newNamedE));
        }
    }
    ...
    public NotificationChain basicSetOpE(final OpEType newOpE, NotificationChain msgs) {
        ...
        if (this.eNotificationRequired()) {
            final ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    FxtranPackage.LOWER_BOUND_TYPE__OP_E, oldOpE, newOpE);
            if (msgs == null) {
                msgs = notification;
            } else {
                msgs.add(notification);
        ...
        if (newOpE != this.opE) {
            ...
            if (this.opE != null) {
                msgs = ((InternalEObject) this.opE).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - FxtranPackage.LOWER_BOUND_TYPE__OP_E, null, msgs);
            }
            if (newOpE != null) {
            ...
            this.eNotify(new ENotificationImpl(this, Notification.SET, FxtranPackage.LOWER_BOUND_TYPE__OP_E, newOpE,
                    newOpE));
        }
    }
