...
public abstract class AbstractTransformationStep {
	...
	protected static final AssemblyFactoryImpl FACTORY = new AssemblyFactoryImpl();
	...
	public abstract void applyTransformation(AssemblyModel model); // NOCS wrong error
}
