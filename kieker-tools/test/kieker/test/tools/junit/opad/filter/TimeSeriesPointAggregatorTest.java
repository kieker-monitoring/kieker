...
public class TimeSeriesPointAggregatorTest extends AbstractKiekerTest {
	...
	public void testGlobalTimescope() throws InterruptedException, IllegalStateException, AnalysisConfigurationException {
		...
		Assert.assertEquals(OP_SIGNATURE_D, sinkList.get(2).getName());
		Assert.assertEquals(1000.0, sinkList.get(2).getDoubleValue(), EPSILON);
		// Expected: 1000 Application C
		Assert.assertEquals(OP_SIGNATURE_C, sinkList.get(1).getName());
		...
		Assert.assertEquals(OP_SIGNATURE_D, sinkList.get(6).getName());
		Assert.assertEquals(5000.0, sinkList.get(6).getDoubleValue(), EPSILON);
		// Expected: 5000 Application C
		Assert.assertEquals(OP_SIGNATURE_C, sinkList.get(5).getName());
		...
		Assert.assertEquals(OP_SIGNATURE_D, sinkList.get(10).getName());
		Assert.assertEquals(Double.NaN, sinkList.get(10).getDoubleValue(), EPSILON);
		// Expected: NaN Application C
		Assert.assertEquals(OP_SIGNATURE_C, sinkList.get(9).getName());
		...
		// Expected: NaN Application D
		Assert.assertEquals(OP_SIGNATURE_D, sinkList.get(14).getName());
		Assert.assertEquals(Double.NaN, sinkList.get(14).getDoubleValue(), EPSILON);
		// Expected: NaN Application C
		Assert.assertEquals(OP_SIGNATURE_C, sinkList.get(13).getName());
