...
public final class ModelUtils {
	...
	public static boolean isEqual(final DeployedComponent leftComponent, final DeployedComponent rightComponent) {
		ModelUtils.isContained(leftComponent, "left component " + leftComponent.getSignature());
		ModelUtils.isContained(rightComponent, "right component " + rightComponent.getSignature());
	...
	private static void isContained(final DeployedComponent component, final String signature) {
		ModelUtils.check(component, signature);
