 ...
 ***************************************************************************/
package kieker.tools.trace.analysis.tt.visualization.descriptions;
...
import kieker.tools.trace.analysis.tt.visualization.AbstractGraphFilter;
...
public class DescriptionDecoratorFilter<V extends AbstractPayloadedVertex<V, E, O, ISystemModelElement>, E extends AbstractEdge<V, E, O>, O> extends
	 ...
	 */
	public DescriptionDecoratorFilter(final DescriptionRepository repository) {
		super();
