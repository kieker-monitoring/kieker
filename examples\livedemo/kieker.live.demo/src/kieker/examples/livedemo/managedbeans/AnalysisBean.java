...
import kieker.examples.livedemo.filter.Distributor;
import kieker.examples.livedemo.filter.OER2EnrichedOERFilter;
import kieker.examples.livedemo.filter.display.AbstractAggregatingDisplayFilter;
import kieker.examples.livedemo.filter.display.AbstractNonAggregatingDisplayFilter;
import kieker.examples.livedemo.filter.display.ClassLoadingDisplayFilter;
import kieker.examples.livedemo.filter.display.CompilationDisplayFilter;
import kieker.examples.livedemo.filter.display.GCCountDisplayFilter;
import kieker.examples.livedemo.filter.display.GCTimeDisplayFilter;
import kieker.examples.livedemo.filter.display.JVMHeapDisplayFilter;
import kieker.examples.livedemo.filter.display.JVMNonHeapDisplayFilter;
import kieker.examples.livedemo.filter.display.MethodResponsetimeDisplayFilter;
import kieker.examples.livedemo.filter.display.ThreadsStatusDisplayFilter;
