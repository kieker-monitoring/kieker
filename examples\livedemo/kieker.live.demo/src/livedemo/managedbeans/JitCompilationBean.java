 ...
 * @since 1.10
 */
@ManagedBean(name = "jitCompilationBean", eager = true)
@ViewScoped
public class JitCompilationBean implements Observer {
	...
	@PostConstruct
	public void init() {
		this.plot = this.analysisBean.getJitCompilationDisplayFilter().getPlot();
		this.updateModels();
