 ...
 * @since 1.10
 */
@ManagedBean(name = "threadsStatusBean", eager = true)
@ViewScoped
public class ThreadsStatusBean implements Observer {
	...
	@PostConstruct
	public void init() {
		this.plot = this.analysisBean.getThreadsStatusDisplayFilter().getPlot();
		this.updateModels();
