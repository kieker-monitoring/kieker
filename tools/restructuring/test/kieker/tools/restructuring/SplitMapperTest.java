...
class SplitMapperTest {
	...
	private Map<String, String> opToCG;
	private Map<String, String> opToCO;
	...
	void initOrig() {
		...
		final AssemblyComponent a = factory.createAssemblyComponent();
		final AssemblyComponent b = factory.createAssemblyComponent();
		final AssemblyComponent c = factory.createAssemblyComponent();
		...
		final AssemblyOperation opA1 = factory.createAssemblyOperation();
		final AssemblyOperation opA2 = factory.createAssemblyOperation();
		final AssemblyOperation opA3 = factory.createAssemblyOperation();
		final AssemblyOperation opA4 = factory.createAssemblyOperation();
		final AssemblyOperation opA5 = factory.createAssemblyOperation();

		final AssemblyOperation opB1 = factory.createAssemblyOperation();
		final AssemblyOperation opB2 = factory.createAssemblyOperation();

		final AssemblyOperation opC1 = factory.createAssemblyOperation();
		final AssemblyOperation opC2 = factory.createAssemblyOperation();
	...
	void initGoal() {
		...
		final AssemblyComponent d = factory.createAssemblyComponent();
		final AssemblyComponent e = factory.createAssemblyComponent();
		final AssemblyComponent f = factory.createAssemblyComponent();
