...
import kieker.tools.settings.validators.PathIsModelDirectoryValidator;
...
public class Settings { // NOPMD
	...
	@Parameter(names = { "-m",
		"--mode" }, required = true, variableArity = true, converter = GraphGenerationConverter.class,
			description = "Mode deciding whether an edge is added when its nodes are not selected")
