...
public class PlantUMLTraceAnalysisConfiguration extends AbstractTraceAnalysisConfiguration {
    ...
    public PlantUMLTraceAnalysisConfiguration(final TraceAnalysisParameters parameters,
    ...
    protected void createPlotSequenceDiagrams(final SystemModelRepository systemRepository,
        ...
        final PlantUMLSequenceDiagramFilter.SDModes plantMode = PlantUMLSequenceDiagramFilter.SDModes
                .valueOf(sequenceDiagramMode.name());
        final PlantUMLSequenceDiagramFilter plantUMLSequenceDiagramFilter = new PlantUMLSequenceDiagramFilter(
                systemRepository, plantMode,
    ...
    protected void createPlotDeploymentComponentDependencyGraph(final SystemModelRepository systemRepository,
        ...
        final PlantUMLGraphWriterPlugin writerStage = new PlantUMLGraphWriterPlugin(outputPathName, outputFileName,
                includeWeights, shortLabels, plotLoops);
