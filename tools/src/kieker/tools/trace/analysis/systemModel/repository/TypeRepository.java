...
public class TypeRepository extends AbstractSystemSubRepository {
	...
	private final Map<String, ComponentType> componentTypesByName = new Hashtable<>(); // NOPMD (UseConcurrentHashMap)
	private final Map<Integer, ComponentType> componentTypesById = new Hashtable<>(); // NOPMD (UseConcurrentHashMap)
