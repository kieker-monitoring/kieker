...
/**
 * PlantUML variant of
 * {@link kieker.visualization.trace.call.tree.dot.AggregatedAllocationComponentOperationCallTreeFilter}.
 * 
 * @author Yorrick Josuttis
 */
public class PlantUMLAggregatedAllocationComponentOperationCallTreeFilter
     ...
     *                       output file name
     */
    public PlantUMLAggregatedAllocationComponentOperationCallTreeFilter(final SystemModelRepository repository,
        ...
        this.setRoot(new PlantUMLAggregatedAllocationComponentOperationCallTreeNode(
 ...
 * @author Yorrick Josuttis
 */
class PlantUMLAggregatedAllocationComponentOperationCallTreeNode
        extends AbstractAggregatedCallTreeNode<AllocationComponentOperationPair> {

    public PlantUMLAggregatedAllocationComponentOperationCallTreeNode(final int id,
    ...
    public AbstractCallTreeNode<AllocationComponentOperationPair> newCall(final AllocationComponentOperationPair dstObj,
        ...
        if (e != null) {
            ...
            n = new PlantUMLAggregatedAllocationComponentOperationCallTreeNode(destination.getId(), destination, false,
                    origin, originPolicy); // !
            // rootNode
