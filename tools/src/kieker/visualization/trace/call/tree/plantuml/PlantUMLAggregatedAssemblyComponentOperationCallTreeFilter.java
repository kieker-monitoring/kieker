...
/**
 * PlantUML variant of
 * {@link kieker.visualization.trace.call.tree.dot.AggregatedAssemblyComponentOperationCallTreeFilter}.
 * 
...
public class PlantUMLAggregatedAssemblyComponentOperationCallTreeFilter
     ...
     *
     */
    public PlantUMLAggregatedAssemblyComponentOperationCallTreeFilter(final SystemModelRepository repository,
...
class PlantUMLAggregatedAssemblyComponentOperationCallTreeNode
    ...
    public PlantUMLAggregatedAssemblyComponentOperationCallTreeNode(final int id,
    ...
    public AbstractCallTreeNode<AssemblyComponentOperationPair> newCall(final AssemblyComponentOperationPair dstObj,
        ...
        if (edgeToTargetNode != null) {
            ...
            targetNode = new PlantUMLAggregatedAssemblyComponentOperationCallTreeNode(destination.getId(), destination,
                    false,
