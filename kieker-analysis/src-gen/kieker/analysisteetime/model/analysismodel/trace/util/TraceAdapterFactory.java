/**
 */
package kieker.analysisteetime.model.analysismodel.trace.util;
...
public class TraceAdapterFactory extends AdapterFactoryImpl {
	...
	protected TraceSwitch<Adapter> modelSwitch =
		new TraceSwitch<Adapter>() {
			...
			@Override
			public Adapter caseFailedOperationCall(FailedOperationCall object) {
				return createFailedOperationCallAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link kieker.analysisteetime.model.analysismodel.trace.OperationCall <em>Operation Call</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link kieker.analysisteetime.model.analysismodel.trace.FailedOperationCall <em>Failed Operation Call</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createFailedOperationCallAdapter() {
		return null;
	}
