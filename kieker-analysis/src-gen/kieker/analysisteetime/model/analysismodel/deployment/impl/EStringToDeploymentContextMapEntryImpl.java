...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>EString To Deployment Context Map Entry</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link kieker.analysisteetime.model.analysismodel.deployment.impl.EStringToDeploymentContextMapEntryImpl#getTypedKey <em>Key</em>}</li>
 * <li>{@link kieker.analysisteetime.model.analysismodel.deployment.impl.EStringToDeploymentContextMapEntryImpl#getTypedValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EStringToDeploymentContextMapEntryImpl extends MinimalEObjectImpl.Container implements BasicEMap.Entry<String, DeploymentContext> {
	 ...
	 * @ordered
	 */
	protected DeploymentContext value;
	...
	protected EClass eStaticClass() {
		return DeploymentPackage.Literals.ESTRING_TO_DEPLOYMENT_CONTEXT_MAP_ENTRY;
	}
	...
	public NotificationChain basicSetTypedValue(DeploymentContext newValue, NotificationChain msgs) {
		...
		value = newValue;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DeploymentPackage.ESTRING_TO_DEPLOYMENT_CONTEXT_MAP_ENTRY__VALUE,
					oldValue, newValue);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setTypedValue(DeploymentContext newValue) {
		if (newValue != value) {
			...
			if (value != null)
				msgs = ((InternalEObject) value).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DeploymentPackage.ESTRING_TO_DEPLOYMENT_CONTEXT_MAP_ENTRY__VALUE,
						null, msgs);
			if (newValue != null)
