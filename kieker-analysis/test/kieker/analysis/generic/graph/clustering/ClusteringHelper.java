...
import kieker.analysis.generic.graph.mtree.BalancedPartitionFunction;
import kieker.analysis.generic.graph.mtree.ComposedSplitFunction;
import kieker.analysis.generic.graph.mtree.IDistanceFunction;
import kieker.analysis.generic.graph.mtree.IPartitionFunction;
import kieker.analysis.generic.graph.mtree.IPromotionFunction;
import kieker.analysis.generic.graph.mtree.ISplitFunction;
import kieker.analysis.generic.graph.mtree.RandomPromotionFunction;
...
public final class ClusteringHelper {
	...
	public static ISplitFunction<Integer> integerSplitFunction() {
		...
		return new ComposedSplitFunction<Integer>(promotionFunction, partitionFunction);
	}
	...
	public static ISplitFunction<OpticsData<Integer>> opticsIntegerSplitFunction() {
		...
		return new ComposedSplitFunction<OpticsData<Integer>>(promotionFunction, partitionFunction);
	}
