 ...
 * @since 1.13
 */
public class DeploymentLevelOperationDependencyGraphBuilderFactory implements DependencyGraphBuilderFactory {
	...
	public DependencyGraphBuilder createDependencyGraphBuilder(final Map<Object, Statistics> statisticsModel) {
		return new DeploymentLevelOperationDependencyGraphBuilder(statisticsModel);
	}
