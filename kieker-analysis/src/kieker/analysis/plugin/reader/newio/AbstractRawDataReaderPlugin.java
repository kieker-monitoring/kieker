 ...
 * @since 1.13
 */
public abstract class AbstractRawDataReaderPlugin extends AbstractReaderPlugin {
	 ...
	 */
	public AbstractRawDataReaderPlugin(final Configuration configuration, final IProjectContext projectContext,
	...
	private IMonitoringRecordDeserializer createDeserializer(final String deserializerClassName,
