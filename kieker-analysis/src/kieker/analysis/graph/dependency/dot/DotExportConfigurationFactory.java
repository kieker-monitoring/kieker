...
package kieker.analysis.graph.dependency.dot;
...
public class DotExportConfigurationFactory {
	...
	/**
	 * Uses TO_STRING of {@link kieker.analysis.graph.dependency.vertextypes.IVertexTypeMapper} as second default argument.
	 *
	 * @param nameBuilder
