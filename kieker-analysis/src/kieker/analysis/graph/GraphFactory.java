...
import kieker.analysis.graph.impl.EdgeImpl;
import kieker.analysis.graph.impl.GraphImpl;
import kieker.analysis.graph.impl.NodeImpl;
...
public final class GraphFactory {
	...
	public static <N extends INode, E extends IEdge> INode createNode(final String id) {
		return new NodeImpl<N, E>(id);
	}
