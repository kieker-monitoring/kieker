 ...
 * @since 1.10
 */
public class GCDisplayStage extends AbstractConsumerStage<GCRecord> {
	 ...
	 */
	public GCDisplayStage(final int numberOfEntries, final TimeUnit recordsTimeUnit) {
	...
	private void updateDisplays(final GCRecord record) {
		...
		this.xyplot.setEntry(id + " - " + GCDisplayStage.COLLECTION_COUNT, minutesAndSeconds, record.getCollectionCount());
		this.xyplot.setEntry(id + " - " + GCDisplayStage.COLLECTION_TIME, minutesAndSeconds, record.getCollectionTimeMS());
	}
