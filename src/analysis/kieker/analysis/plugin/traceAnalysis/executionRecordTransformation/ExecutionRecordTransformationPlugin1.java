 ...
 */
public class ExecutionRecordTransformationPlugin1 extends AbstractTraceAnalysisPlugin implements IMonitoringRecordConsumerPlugin {

    private static final Log log = LogFactory.getLog(ExecutionRecordTransformationPlugin1.class);

    public ExecutionRecordTransformationPlugin1(
            final String name,
