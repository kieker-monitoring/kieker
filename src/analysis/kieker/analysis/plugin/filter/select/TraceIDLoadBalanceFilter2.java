...
@Plugin(
		outputPorts = {
			@OutputPort(name = TraceIDLoadBalanceFilter2.OUTPUT_PORT_NAME_1, eventTypes = { Trace.class, AbstractTraceEvent.class }),
			@OutputPort(name = TraceIDLoadBalanceFilter2.OUTPUT_PORT_NAME_2, eventTypes = { Trace.class, AbstractTraceEvent.class })
		})
public class TraceIDLoadBalanceFilter2 extends AbstractFilterPlugin {
	...
	public TraceIDLoadBalanceFilter2(final Configuration configuration, final IProjectContext projectContext) {
