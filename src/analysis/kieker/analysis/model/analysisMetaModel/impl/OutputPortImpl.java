 ...
 * <ul>
 *   <li>{@link kieker.analysis.model.analysisMetaModel.impl.OutputPortImpl#getOutConnector <em>Out Connector</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OutputPortImpl extends PortImpl implements OutputPort {
	 ...
	 * @ordered
	 */
	protected EList<Connector> outConnector;
	...
	protected EClass eStaticClass() {
		return AnalysisMetaModelPackage.Literals.OUTPUT_PORT;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case AnalysisMetaModelPackage.OUTPUT_PORT__OUT_CONNECTOR:
				...
				getOutConnector().addAll((Collection<? extends Connector>)newValue);
				return;
		}
