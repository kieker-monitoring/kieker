...
public class AnalysisMetaModelSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case AnalysisMetaModelPackage.PROJECT: {
			...
			case AnalysisMetaModelPackage.PLUGIN: {
				Plugin plugin = (Plugin)theEObject;
				T result = casePlugin(plugin);
				if (result == null) result = caseConfigurable(plugin);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AnalysisMetaModelPackage.CONNECTOR: {
				Connector connector = (Connector)theEObject;
				T result = caseConnector(connector);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AnalysisMetaModelPackage.CONFIGURABLE: {
				Configurable configurable = (Configurable)theEObject;
				T result = caseConfigurable(configurable);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AnalysisMetaModelPackage.PORT: {
				Port port = (Port)theEObject;
				T result = casePort(port);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AnalysisMetaModelPackage.INPUT_PORT: {
			...
			case AnalysisMetaModelPackage.OUTPUT_PORT: {
			...
			case AnalysisMetaModelPackage.CLASS: {
				kieker.analysis.model.analysisMetaModel.Class class_ = (kieker.analysis.model.analysisMetaModel.Class)theEObject;
	 ...
	 * @generated
	 */
	public T caseClass(kieker.analysis.model.analysisMetaModel.Class object) {
		return null;
	}
