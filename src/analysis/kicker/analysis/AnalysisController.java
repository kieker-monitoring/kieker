...
import kicker.common.record.misc.KickerMetadataRecord;
...
public final class AnalysisController implements IAnalysisController { // NOPMD (really long class)
	...
	/**
	 * Called whenever an {@link KickerMetadataRecord} is found inside the filters network.
	 * 
	 * Currently this method only logs all details.
	 * 
	 * @param record
	 *            the KickerMetadataRecord containing the information
	 */
	public final void handleKickerMetadataRecord(final KickerMetadataRecord record) {
