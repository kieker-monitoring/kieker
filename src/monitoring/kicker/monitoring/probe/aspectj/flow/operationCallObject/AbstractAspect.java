...
public abstract class AbstractAspect extends AbstractAspectJProbe {
	...
	@Around("monitoredOperation() && this(thisObject) && target(targetObject) && notWithinKicker()")
	...
	@Around("monitoredOperation() && !this(java.lang.Object) && target(targetObject) && notWithinKicker()")
	public Object static2memberOperation(final Object targetObject, final ProceedingJoinPoint thisJoinPoint, final EnclosingStaticPart thisEnclosingJoinPoint)
		...
		// measure before call
		CTRLINST.newMonitoringRecord(new CallOperationObjectEvent(TIME.getTime(), traceId, trace.getNextOrderId(),
				caller, callerClazz, callee, calleeClazz, 0, calleeObject));
		// call of the called method
		final Object retval;
		try {
			retval = thisJoinPoint.proceed();
	...
	@Around("monitoredOperation() && this(thisObject) && !target(java.lang.Object) && notWithinKicker()")
	public Object member2staticOperation(final Object thisObject, final ProceedingJoinPoint thisJoinPoint,
		...
		// measure before call
		CTRLINST.newMonitoringRecord(new CallOperationObjectEvent(TIME.getTime(), traceId, trace.getNextOrderId(),
				caller, callerClazz, callee, calleeClazz, callerObject, 0));
		// call of the called method
		final Object retval;
		try {
			retval = thisJoinPoint.proceed();
	...
	@Around("monitoredOperation() && !this(java.lang.Object) && !target(java.lang.Object) && notWithinKicker()")
	public Object static2staticOperation(final ProceedingJoinPoint thisJoinPoint, final EnclosingStaticPart thisEnclosingJoinPoint)
		...
		// measure before call
		CTRLINST.newMonitoringRecord(new CallOperationObjectEvent(TIME.getTime(), traceId, trace.getNextOrderId(),
				caller, callerClazz, callee, calleeClazz, 0, 0));
		// call of the called method
		final Object retval;
		try {
			retval = thisJoinPoint.proceed();
