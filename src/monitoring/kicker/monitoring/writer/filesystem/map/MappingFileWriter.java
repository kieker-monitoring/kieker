...
package kicker.monitoring.writer.filesystem.map;
...
/**
 * This writer is a helper class to handle the mapping files for Kicker's records, containing the mapping between short IDs and actual record classes. It provides
