...
public class OperationExecutionAspectFullServlet extends AbstractOperationExecutionAspectServlet {
	private static final Log LOG = LogFactory.getLog(OperationExecutionAspectFullServlet.class);
	...
	public Object doBasicProfiling(final ProceedingJoinPoint thisJoinPoint) throws Throwable { // NOCS (IllegalThrowsCheck)
		...
		try {
			...
			if ((eoi == -1) || (ess == -1)) {
				OperationExecutionAspectFullServlet.LOG.error("eoi and/or ess have invalid values:" + " eoi == " + eoi + " ess == " + ess);
				OperationExecutionAspectFullServlet.LOG.error("Terminating!");
