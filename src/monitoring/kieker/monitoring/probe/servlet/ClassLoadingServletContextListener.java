 ...
 * @since 1.10
 */
public class ClassLoadingServletContextListener implements ServletContextListener {
	...
	private static final Log LOG = LogFactory.getLog(ClassLoadingServletContextListener.class);
	...
	private void initSensors() {
		...
		final ScheduledSamplerJob job = this.samplingController.schedulePeriodicSampler(sampler, ClassLoadingServletContextListener.this.initialDelaySeconds,
				ClassLoadingServletContextListener.this.sensorIntervalSeconds, TimeUnit.SECONDS);
