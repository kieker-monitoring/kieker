 ...
 */
public class CPUsCombinedServletContextListener implements
		ServletContextListener {

	private static final Log log = LogFactory
			.getLog(CPUsCombinedServletContextListener.class);
	...
	private void initSensors() {
		...
		final CPUsCombinedPercSampler cpuSensor =
				sigarFactory.createSensorCPUsCombinedPerc();
		final ScheduledSamplerJob cpuSensorJob =
				this.monitoringController
						.schedulePeriodicSampler(
								...
								CPUsCombinedServletContextListener.SENSOR_INTERVAL_SECONDS,
								TimeUnit.SECONDS);
