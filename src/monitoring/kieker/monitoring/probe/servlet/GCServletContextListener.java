 ...
 * @since 1.10
 */
public class GCServletContextListener implements ServletContextListener {
	...
	private static final Log LOG = LogFactory.getLog(GCServletContextListener.class);
	...
	private void initSensors() {
		...
		final ScheduledSamplerJob job = this.samplingController.schedulePeriodicSampler(gcSampler, GCServletContextListener.this.initialDelaySeconds,
				GCServletContextListener.this.sensorIntervalSeconds, TimeUnit.SECONDS);
