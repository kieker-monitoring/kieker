...
public abstract class AbstractOperationExecutionMethodInvocationInterceptor implements MethodInterceptor, IMonitoringProbe {
    ...
    private static final Log log = LogFactory.getLog(AbstractOperationExecutionMethodInvocationInterceptor.class);
    ...
    protected void proceedAndMeasure(MethodInvocation invocation,
        ...
        execData.tin = tpmonController.currentTimeNanos();
        try {
            ...
            execData.tout = tpmonController.currentTimeNanos();
