...
public class RSrvException extends Exception {
	...
	public String getMessage() {
		return super.getMessage() + ((this.reqReturnCode != -1) ? ", request status: " + this.getRequestErrorDescription() : "");
	}

	public RSrvException(final Rconnection c, final String msg) {
		this(c, msg, -1);
	}

	public RSrvException(final Rconnection c, final String msg, final int requestReturnCode) {
		super(msg);
		this.conn = c;
	...
	public RSrvException(final Rconnection c, final String msg, final Rpacket p) {
