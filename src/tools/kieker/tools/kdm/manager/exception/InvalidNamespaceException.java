...
/**
 * This class represents an exception that occurs if an invalid namespace has been passed to a method.
 * 
...
public class InvalidNamespaceException extends Exception {
	 ...
	 */
	public InvalidNamespaceException(final Throwable cause) {
		super(cause);
	}
