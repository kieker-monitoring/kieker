...
public final class Constants {
	...
	public static final String CMD_OPT_NAME_REPAIR_TRACE_WITH_MISSING_AFTEREVENT = "repair-trace-with-missing-afterevent";
	...
	public static final String DECORATORS_OPTION_NAME = "responseTimes | responseTimes-ns | responseTimes-us | responseTimes-ms | responseTimes-s> "
			+ "<responseTimeColoring threshold(ms)";
	public static final char DECORATOR_SEPARATOR = ',';
	/**
	 * @deprecated Replaced by {@link #RESPONSE_TIME_DECORATOR_FLAG_MS}. To be removed for 1.11 if possible.
	 */
	@Deprecated
	...
	static {
		...
		SORTED_OPTION_LIST.add(OptionBuilder.withLongOpt(CMD_OPT_NAME_REPAIR_TRACE_WITH_MISSING_AFTEREVENT).hasArg(false).isRequired(false)
				.withDescription("If selected, traces with missing AfterEvents e.g. because of software crash will be repaired.").create());
