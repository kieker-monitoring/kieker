 ...
 */
@Plugin
public abstract class AbstractGraphProducingFilter<G extends AbstractGraph<?, ?, ?>> extends AbstractMessageTraceProcessingFilter {
	...
	public void terminate(final boolean error) {
		if (!error) {
			this.deliver(GRAPH_OUTPUT_PORT_NAME, this.getGraph());
		}
	}
