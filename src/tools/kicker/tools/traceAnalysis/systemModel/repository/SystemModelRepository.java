...
/**
 * This repository is a model manager for the Kicker's component model. It consists of multiple "sub"repositories.
 * 
...
@Repository(
		...
		description = "Model manager for Kicker's component model ")
	...
	public void saveSystemToHTMLFile(final String outputFn) throws FileNotFoundException, UnsupportedEncodingException {
		...
		for (final ComponentType type : componentTypes) {
			...
			final String[] cells = new String[] {
				...
				SystemModelRepository.simpleHTMLEscape(type.getPackageName()), SystemModelRepository.simpleHTMLEscape(type.getTypeName()), opListBuilder.toString(), };
