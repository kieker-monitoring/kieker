...
public class BeforeConstructorObjectEvent extends BeforeConstructorEvent implements IObjectRecord {
	...
	private static final long serialVersionUID = 8437428469894463116L;
	 ...
	 *            The object ID.
	 */
	public BeforeConstructorObjectEvent(final long timestamp, final long traceId, final int orderIndex, final String operationSignature,
	 ...
	 */
	public BeforeConstructorObjectEvent(final Object[] values) { // NOPMD (values stored directly)
	 ...
	 */
	protected BeforeConstructorObjectEvent(final Object[] values, final Class<?>[] types) { // NOPMD (values stored directly)
		super(values, types); // values[0..4]
		this.objectId = (Integer) values[5];
	}
	 ...
	 */
	public BeforeConstructorObjectEvent(final ByteBuffer buffer, final IRegistry<String> stringRegistry) throws BufferUnderflowException {
