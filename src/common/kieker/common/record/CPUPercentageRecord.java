 ...
 * 
 */
public class CPUPercentageRecord extends AbstractMonitoringRecord {
	 ...
	 */
	private volatile String hostName = CPUPercentageRecord.DEFAULT_VALUE;

	/**
	 * Name of the resource.
	 */
	private volatile String resourceName =
			CPUPercentageRecord.DEFAULT_VALUE;
	...
	public void initFromArray(final Object[] values)
		...
		try {
			if (values.length != CPUPercentageRecord.VALUE_TYPES.length) {
				throw new IllegalArgumentException("Expecting vector with "
						+ CPUPercentageRecord.VALUE_TYPES.length
	 ...
	 * @param utilization
	 */
	public CPUPercentageRecord(final long timestamp, final String hostName,
	...
	public Class<?>[] getValueTypes() {
		return CPUPercentageRecord.VALUE_TYPES;
	}
