 ...
 * @since 1.7
 */
public final class KickerMetadataRecord extends AbstractMonitoringRecord implements IMonitoringRecord.Factory, IMonitoringRecord.BinaryFactory {
	public static final int SIZE = (3 * TYPE_SIZE_STRING) + TYPE_SIZE_INT + TYPE_SIZE_BOOLEAN + TYPE_SIZE_LONG + TYPE_SIZE_STRING + TYPE_SIZE_LONG;
	 ...
	 * 
	 * @param version
	 *            The Kicker version (can be null).
	 ...
	 */
	public KickerMetadataRecord(final String version, final String controllerName, final String hostname, final int experimentId, final boolean debugMode,
	 ...
	 */
	public KickerMetadataRecord(final Object[] values) { // NOPMD (values stored directly)
	 ...
	 */
	public KickerMetadataRecord(final ByteBuffer buffer, final IRegistry<String> stringRegistry) throws BufferUnderflowException {
	...
	public String toFormattedString() {
		...
		sb.append("Kicker metadata: version='");
