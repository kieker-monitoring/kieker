...
package kicker.common.record.flow.trace.operation.constructor.object.interfaceimpl;
...
public class BeforeConstructorObjectInterfaceEvent extends BeforeConstructorObjectEvent implements IInterfaceRecord {
	 ...
	 */
	public BeforeConstructorObjectInterfaceEvent(final Object[] values) { // NOPMD (values stored directly)
	 ...
	 */
	protected BeforeConstructorObjectInterfaceEvent(final Object[] values, final Class<?>[] types) { // NOPMD (values stored directly)
		super(values, types); // values[0..5]
		this.interfaceImpl = (String) values[6];
	}
