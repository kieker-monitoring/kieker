...
public class AfterConstructorFailedObjectEvent extends AfterConstructorFailedEvent implements IObjectRecord {
	...
	private static final long serialVersionUID = -6208069980027440245L;
	 ...
	 */
	public AfterConstructorFailedObjectEvent(final Object[] values) { // NOPMD (values stored directly)
	 ...
	 */
	protected AfterConstructorFailedObjectEvent(final Object[] values, final Class<?>[] types) { // NOPMD (values stored directly)
		super(values, types); // values[0..5]
		this.objectId = (Integer) values[6];
	}
