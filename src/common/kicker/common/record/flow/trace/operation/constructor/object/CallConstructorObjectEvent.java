...
public class CallConstructorObjectEvent extends CallConstructorEvent implements ICallObjectRecord {
	...
	private static final long serialVersionUID = 5190901469204981870L;
	 ...
	 */
	public CallConstructorObjectEvent(final long timestamp, final long traceId, final int orderIndex,
	 ...
	 */
	public CallConstructorObjectEvent(final Object[] values) { // NOPMD (values stored directly)
	 ...
	 */
	protected CallConstructorObjectEvent(final Object[] values, final Class<?>[] types) { // NOPMD (values stored directly)
		super(values, types); // values[0..6]
		this.callerObjectId = (Integer) values[7];
		this.calleeObjectId = (Integer) values[8];
	}
