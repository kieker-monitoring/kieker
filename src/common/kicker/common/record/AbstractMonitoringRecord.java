...
public abstract class AbstractMonitoringRecord implements IMonitoringRecord {
	...
	static {
		CACHED_KIEKERRECORDS.put("kicker.tpmon.monitoringRecord.executions.KickerExecutionRecord", kicker.common.record.controlflow.OperationExecutionRecord.class);
