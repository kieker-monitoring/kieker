...
public final class FSUtil { // NOCS NOPMD (constants interface)
	...
	/** The prefix of Kicker's record files. */
	public static final String FILE_PREFIX = "kicker";
	/** The name of Kicker's map files. */
	public static final String MAP_FILENAME = "kicker.map";

	/** The old prefix of Kicker's record files. */
	public static final String LEGACY_FILE_PREFIX = "tpmon";
	/** The old name of Kicker's map files. */
	public static final String LEGACY_MAP_FILENAME = "tpmon.map";

	/** The usual extension of Kicker's record files. */
	public static final String NORMAL_FILE_EXTENSION = ".dat";
	/** The extension of Kicker's zipped record files. */
