...
public final class Version {
	...
	private static final String VERSION = "1.10-SNAPSHOT"; // NOPMD (name equals classname)
	private static final String COPYRIGHT = "Copyright (c) 2006-2014 Kicker Project";
